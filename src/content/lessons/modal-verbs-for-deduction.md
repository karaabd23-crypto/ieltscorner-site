...
quiz:
  ...
  - prompt: "Which edit fixes a common Modal verbs for deduction mistake?"
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Modal verbs for deduction error and matches the target form."
premium: false
priceCAD: 0
draft: false
---
...
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This correction matches the intended meaning and keeps Modal verbs for deduction natural.</p>
</article>
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This version sounds more natural because Modal verbs for deduction fits the sentence clearly.</p>
</article>
</div>
