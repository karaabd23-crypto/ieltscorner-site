...
quiz:
  - prompt: "Which sentence uses Relative Clauses With Prepositions correctly?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 matches the main rule for Relative Clauses With Prepositions and keeps the sentence natural."
  - prompt: "What should you check first when editing Relative Clauses With Prepositions?"
    options:
  ...
  - prompt: "Which edit fixes a common Relative Clauses With Prepositions mistake?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Relative Clauses With Prepositions error and matches the target form."
premium: false
priceCAD: 0
draft: false
---
...
## Real-World Examples with Relative Clauses With Prepositions
...
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This correction matches the intended meaning and keeps Relative Clauses With Prepositions natural.</p>
</article>
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This version sounds more natural because Relative Clauses With Prepositions fits the sentence clearly.</p>
</article>
</div>

## Common Errors with Relative Clauses With Prepositions
