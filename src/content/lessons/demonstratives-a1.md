...
clb: "2-3"
exam: ["IELTS", "CELPIP"]
excerpt: "Learn that as demonstrative for A1 level. Clear explanations with practical examples and exercises for IELTS and CELPIP."
date: "2026-03-02"
...
This lesson explains That as Demonstrative with practical patterns and examples, helping beginner learners use English more accurately.
...
<tbody>
  <tr style="border: 1px solid #ddd;">
    ...
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>Students use that as demonstrative to build clear beginner level sentences.</em></td>
  ...
  <tr style="background: #fafafa; border: 1px solid #ddd;">
    ...
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>This pattern helps learners use that as demonstrative with better precision and control.</em></td>
...
```
I use that as demonstrative wrong in this sentence and it sound unclear.
```

### ✅ Correct

```
I used that as demonstrative incorrectly in this sentence, so it sounded unclear.
```
...
> "In this sentence, that as demonstrative is used accurately to express the intended meaning."

**Why this works:** It shows correct grammar control and clear communication.

### Example 2: CELPIP Speaking
> "I used that as demonstrative in my response to make the message precise and natural."
