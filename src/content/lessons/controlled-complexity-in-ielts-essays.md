...
quiz:
  - prompt: "Which sentence uses Complex Writing That Works correctly?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 matches the main rule for Complex Writing That Works and keeps the sentence natural."
  - prompt: "What should you check first when editing Complex Writing That Works?"
    options:
  ...
  - prompt: "Which edit fixes a common Complex Writing That Works mistake?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Complex Writing That Works error and matches the target form."
premium: true
priceCAD: 12
draft: false
---
...
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This correction matches the intended meaning and keeps Complex Writing That Works natural.</p>
</article>
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This version sounds more natural because Complex Writing That Works fits the sentence clearly.</p>
</article>
</div>
