...
quiz:
  ...
  - prompt: "Which edit fixes a common Moving Words for Emphasis mistake?"
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Moving Words for Emphasis error and matches the target form."
premium: true
priceCAD: 12
draft: false
---
...
## Real-World Examples with Moving Words for Emphasis
...
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This correction matches the intended meaning and keeps Moving Words for Emphasis natural.</p>
</article>
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This version sounds more natural because Moving Words for Emphasis fits the sentence clearly.</p>
</article>
</div>

## Common Errors with Moving Words for Emphasis
