...
clb: "9-10"
exam: ["IELTS", "CELPIP"]
excerpt: "C1 prefixes lesson with real word-formation examples, exam-focused practice, and full answer keys."
date: "2026-03-02"
...
---
## Goal
Learn how to use **Word Formation: Prefixes** accurately in IELTS and CELPIP responses.

## What Word Formation: Prefixes Means
This lesson is specifically about **Word Formation: Prefixes**. By the end, you should understand when to use it, how to form it correctly, and how to avoid common errors.

## Topic Explanation and Use
Word Formation: Prefixes controls how base words change part of speech and meaning through suffixes and prefixes (for example, verb to noun, adjective to adverb).

Use Word Formation: Prefixes by identifying the target part of speech in the sentence first, then choosing the affix that creates the needed word class and meaning.
...
Correct each sentence so it uses **Word Formation: Prefixes** naturally.
