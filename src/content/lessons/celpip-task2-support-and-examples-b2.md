...
quiz:
  - prompt: "What should come before full drafting in CELPIP Task 2: Support and Examples?"
    options:
...
## Examples
<p class="lesson-section-lede">&#10024; <strong>Read the examples first.</strong> They show the pattern for <u>CELPIP Task 2: Support and Examples</u> in real sentences.</p>
