...
clb: "9-10"
exam: ["IELTS", "CELPIP"]
excerpt: "C1 suffixes lesson with real word-formation examples, exam-focused practice, and full answer keys."
date: "2026-03-02"
...
---
## Goal
Use **suffixes** to produce nuanced, concise, high-band lexical control.
...
- transparent -> **transparency** (policy noun)
- equal -> **inequality** (social analysis noun)
- resistant -> **resistance** (argument noun)
...
*Governments should prioritize environmental protection even if economic growth slows.*
Requirements:
- one qualified claim
- one concession
