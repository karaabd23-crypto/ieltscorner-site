...
quiz:
  - prompt: "Which sentence uses Combining Clauses Effectively correctly?"
    options:
  ...
  - prompt: "What should you check first when editing Combining Clauses Effectively?"
    options:
  ...
  - prompt: "Which edit fixes a common Combining Clauses Effectively mistake?"
    options:
