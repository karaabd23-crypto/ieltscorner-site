...
quiz:
  - prompt: "Pick the sentence that gets Shall and Will right."
    options:
  ...
  - prompt: "Editing Shall and Will: where should you start?"
    options:
  ...
  - prompt: "Which change fixes a frequent Shall and Will mistake?"
    options:
