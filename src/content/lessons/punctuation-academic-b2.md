...
---
## Goal
Master **Punctuation in Academic Writing** for B2 (controlled complexity) performance in IELTS/CELPIP contexts.
...
Write one argumentative paragraph (6 sentences) using **Punctuation in Academic Writing**.
Requirements:
- claim + counterpoint
...
## Level Deep Dive (B2)
At B2, your writing should show controlled development. Use Punctuation in Academic Writing to build argument progression: claim, evidence, implication.
