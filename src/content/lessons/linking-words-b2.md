...
## Real-World Examples with Linking Words and Transition Phrases
...
<div class="lesson-resource-grid">
  <article class="lesson-resource-card">
    ...
    <ul><li>however: introduces contrast</li><li>in addition: adds another point</li><li>for example: introduces a specific illustration</li><li>as a result: shows consequence</li><li>in contrast: highlights a difference</li><li>therefore: gives a logical conclusion</li></ul>
  </article>
  <article class="lesson-resource-card">
    <p class="lesson-card-label">Useful chunks</p>
    <ul><li>however</li><li>in addition</li><li>for example</li><li>as a result</li></ul>
  </article>
  <article class="lesson-resource-card">
    <p class="lesson-card-label">Sentence frames</p>
    <ul><li>However, this approach...</li><li>For example, one district...</li><li>As a result, ...</li></ul>
  </article>
</div>
