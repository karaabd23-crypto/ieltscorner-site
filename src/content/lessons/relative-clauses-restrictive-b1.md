---
title: "Relative Clauses: Restrictive (B1)"
category: "grammar"
level: "B1"
ieltsBand: "4.5-5.5"
clb: "5-6"
exam: ["IELTS", "CELPIP"]
excerpt: "Learn relative clauses: restrictive for B1 level. Clear explanations with practical examples and exercises for IELTS and CELPIP."
date: "2026-03-02"
...
This lesson explains Relative Clauses: Restrictive with practical patterns and examples, helping intermediate learners use English more accurately.
...
<tbody>
  <tr style="border: 1px solid #ddd;">
    ...
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>Students use relative clauses: restrictive to build clear intermediate level sentences.</em></td>
  ...
  <tr style="background: #fafafa; border: 1px solid #ddd;">
    ...
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>This pattern helps learners use relative clauses: restrictive with better precision and control.</em></td>
...
```
I use relative clauses: restrictive wrong in this sentence and it sound unclear.
```

### ✅ Correct

```
I used relative clauses: restrictive incorrectly in this sentence, so it sounded unclear.
```
...
> "In this sentence, relative clauses: restrictive is used accurately to express the intended meaning."

**Why this works:** It shows correct grammar control and clear communication.

### Example 2: CELPIP Speaking
> "I used relative clauses: restrictive in my response to make the message precise and natural."
