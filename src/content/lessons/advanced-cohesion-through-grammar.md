...
---
## Goal
Master **Connecting Ideas with Grammar** with maximum precision under time pressure.
...
Write 4 sentences using **Connecting Ideas with Grammar**:
- one statement
...
Use **Connecting Ideas with Grammar** at least twice and keep your logic clear.
