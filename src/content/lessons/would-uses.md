...
<article class="practice-task" data-task-type="choice" data-task-answer="1" data-task-id="1" data-correct-feedback="Correct. The better sentence keeps the intended meaning and the Would form fits naturally." data-wrong-feedback="Not yet. Check what the sentence really means before you choose the form.">
...
<article class="practice-task" data-task-type="order" data-task-answer="If the city||improved bus routes,||more people would||choose public||transport." data-task-id="2" data-correct-feedback="Correct. The sentence now reads in a natural English order." data-wrong-feedback="Not yet. Build the sentence around the main subject and verb first.">
...
<button type="button" class="practice-chip" data-chip-value="more people would" data-chip-origin="bank-1" data-chip-id="1-0">
  more people would
</button>
<button type="button" class="practice-chip" data-chip-value="choose public" data-chip-origin="bank-1" data-chip-id="1-1">
  choose public
</button>
<button type="button" class="practice-chip" data-chip-value="improved bus routes," data-chip-origin="bank-1" data-chip-id="1-2">
  improved bus routes,
</button>
<button type="button" class="practice-chip" data-chip-value="If the city" data-chip-origin="bank-1" data-chip-id="1-3">
  If the city
</button>
<button type="button" class="practice-chip" data-chip-value="transport." data-chip-origin="bank-1" data-chip-id="1-4">
  transport.
</button>
  </div>
...
<div class="practice-sort-row" data-sort-target="works" data-sort-row="0">
  <p>When we were children, we would visit our grandparents every summer.</p>
...
<div class="practice-sort-row" data-sort-target="fix" data-sort-row="1">
  <p>When we were children, we would to visit our grandparents every summer.</p>
  <div class="practice-sort-actions">
    <button type="button" class="practice-sort-btn" data-sort-choice="works">Works</button>
    <button type="button" class="practice-sort-btn" data-sort-choice="fix">Needs fixing</button>
  </div>
...
<div class="practice-sort-row" data-sort-target="works" data-sort-row="2">
  <p>If the city improved bus routes, more people would choose public transport.</p>
  <div class="practice-sort-actions">
    <button type="button" class="practice-sort-btn" data-sort-choice="works">Works</button>
    <button type="button" class="practice-sort-btn" data-sort-choice="fix">Needs fixing</button>
  </div>
...
<div class="practice-sort-row" data-sort-target="fix" data-sort-row="3">
  <p>If the city improved bus routes, more people would chose public transport.</p>
  <div class="practice-sort-actions">
    <button type="button" class="practice-sort-btn" data-sort-choice="works">Works</button>
    <button type="button" class="practice-sort-btn" data-sort-choice="fix">Needs fixing</button>
  </div>
