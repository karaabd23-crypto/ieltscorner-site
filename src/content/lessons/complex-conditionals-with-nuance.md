...
---
## Goal
Master **Complex If-Statements** with high-information, concise argumentation.
...
Write 4 sentences using **Complex If-Statements**:
- one statement
...
Use **Complex If-Statements** at least twice and keep your logic clear.
