...
quiz:
  - prompt: "Which sentence uses Complex If-Statements correctly?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 matches the main rule for Complex If-Statements and keeps the sentence natural."
  - prompt: "What should you check first when editing Complex If-Statements?"
    options:
  ...
  - prompt: "Which edit fixes a common Complex If-Statements mistake?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Complex If-Statements error and matches the target form."
premium: true
priceCAD: 12
draft: false
---
...
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This correction matches the intended meaning and keeps Complex If-Statements natural.</p>
</article>
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This version sounds more natural because Complex If-Statements fits the sentence clearly.</p>
</article>
</div>
