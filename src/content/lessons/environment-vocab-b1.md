...
clb: "5-6"
exam: ["IELTS", "CELPIP"]
excerpt: "Learn environment and ecology for B1 level. Clear explanations with practical examples and exercises for IELTS and CELPIP."
date: "2026-03-02"
...
This lesson teaches Environment and Ecology for intermediate learners, so you can choose more precise words in IELTS and CELPIP responses.
...
<tbody>
  <tr style="border: 1px solid #ddd;">
    ...
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>The speaker gave a clear example of environment and ecology during the lesson.</em></td>
  ...
  <tr style="background: #fafafa; border: 1px solid #ddd;">
    ...
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>We practiced useful phrases related to environment and ecology in pairs.</em></td>
...
```
The essay used environment and ecology in a not clear way.
```

### ✅ Correct

```
The essay used environment and ecology in a clearer and more precise way.
```
...
> "In this sentence, environment and ecology is used accurately to express the intended meaning."

**Why this works:** It shows correct grammar control and clear communication.

### Example 2: CELPIP Speaking
> "I used environment and ecology in my response to make the message precise and natural."
