---
title: "Phrasal Verbs: Emotions (B1)"
category: "vocabulary"
level: "B1"
ieltsBand: "4.5-5.5"
clb: "5-6"
exam: ["IELTS", "CELPIP"]
excerpt: "B1 vocabulary lesson on Phrasal Verbs: Emotions with a practical word bank, collocations, and retrieval practice."
date: "2026-03-02"
...
---
<div class="lesson-context"><p class="lesson-context-lead"><strong>Phrasal Verbs: Emotions</strong> is about the words and phrases you need for real English. This lesson shows what the key words mean, where they fit, and how to use them in natural sentences without sounding forced.</p></div>

## Examples
<p class="lesson-section-lede">&#10024; <strong>Read the examples first.</strong> They show the pattern for <u>Phrasal Verbs: Emotions</u> in real sentences.</p>
...
<p>Phrasal Verbs: Emotions teaches verb + particle combinations that are common in everyday English and must be learned as full phrases.</p>
...
<div class="practice-lab" data-practice-lab>
  <div class="practice-lab-head">
    <div>
      <h3>Practice</h3>
      <p class="practice-lab-intro">Start with meaning. Then move to collocations and sentence control for Phrasal Verbs: Emotions.</p>
    </div>
...
<article class="practice-task" data-task-type="order" data-task-answer="Calm down works||best when the||meaning is clear||in the||sentence." data-task-id="1">
...
<button type="button" class="practice-chip" data-chip-value="Calm down works" data-chip-origin="bank-1" data-chip-id="1-0">
  Calm down works
</button>
...
<article class="practice-task" data-task-type="typing" data-task-answers="topic" data-task-id="2">
  ...
  <p class="practice-source-line"><span>Fix this:</span> calm down: become less upset</p>
...
## Why It Matters
<p class="lesson-importance"><strong>&#127919; Why it matters:</strong> good vocabulary is not just about knowing a word. You need the <em>right</em> word in the <em>right</em> sentence. When you control Phrasal Verbs: Emotions, you sound clearer, more natural, and more precise in real English.</p>
