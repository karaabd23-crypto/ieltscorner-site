...
clb: "7-8"
exam: ["IELTS", "CELPIP"]
excerpt: "Learn gerunds and infinitives for B2 level. Clear explanations with practical examples and exercises for IELTS and CELPIP."
date: "2026-03-02"
...
This lesson explains Gerunds and Infinitives with practical patterns and examples, helping intermediate learners use English more accurately.
...
<tbody>
  <tr style="border: 1px solid #ddd;">
    ...
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>Students use gerunds and infinitives to build clear intermediate level sentences.</em></td>
  ...
  <tr style="background: #fafafa; border: 1px solid #ddd;">
    ...
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>This pattern helps learners use gerunds and infinitives with better precision and control.</em></td>
...
```
I use gerunds and infinitives wrong in this sentence and it sound unclear.
```

### ✅ Correct

```
I used gerunds and infinitives incorrectly in this sentence, so it sounded unclear.
```
...
> "In this sentence, gerunds and infinitives is used accurately to express the intended meaning."

**Why this works:** It shows correct grammar control and clear communication.

### Example 2: CELPIP Speaking
> "I used gerunds and infinitives in my response to make the message precise and natural."
