...
quiz:
  - prompt: "Which sentence handles Can and cannot for ability the right way?"
    options:
  ...
  - prompt: "Editing Can and cannot for ability: where should you start?"
    options:
  ...
  - prompt: "Which fix addresses a usual Can and cannot for ability error?"
    options:
