...
quiz:
  - prompt: "Which sentence uses Can and cannot for ability correctly?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 matches the main rule for Can and cannot for ability and keeps the sentence natural."
  - prompt: "What should you check first when editing Can and cannot for ability?"
    options:
  ...
  - prompt: "Which edit fixes a common Can and cannot for ability mistake?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Can and cannot for ability error and matches the target form."
premium: false
priceCAD: 0
draft: false
---
...
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This correction matches the intended meaning and keeps Can and cannot for ability natural.</p>
</article>
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This version sounds more natural because Can and cannot for ability fits the sentence clearly.</p>
</article>
</div>
