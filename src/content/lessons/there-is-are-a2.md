...
clb: "3-4"
exam: ["IELTS", "CELPIP"]
excerpt: "A2 lesson on There is, There are with teacher-style explanation, guided practice, and topic-linked review."
date: "2026-03-02"
...
quiz:
  ...
  - prompt: "Which edit fixes a common There is, There are mistake?"
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical There is, There are error and matches the target form."
---
<div class="lesson-context"><p class="lesson-context-lead"><strong>There is, There are</strong> helps English sentences carry tense, negatives, questions, and emphasis. Small helper verbs like <em>be</em>, <em>do</em>, and <em>have</em> do a lot of work. In this lesson, you will learn how these forms support the sentence.</p></div>

## Examples
<p class="lesson-section-lede">&#10024; <strong>Read the examples first.</strong> They show the pattern for <u>There is, There are</u> in real sentences.</p>
...
<article class="practice-task" data-task-type="choice" data-task-answer="1" data-task-id="0" data-correct-feedback="Correct. The better sentence keeps the intended meaning and the There is, There are form fits naturally." data-wrong-feedback="Not yet. Check what the sentence really means before you choose the form.">
...
<article class="practice-task" data-task-type="typing" data-task-answers="Does she need to bring her passport tomorrow?" data-task-id="2" data-correct-feedback="Correct. You repaired the sentence without changing the message." data-wrong-feedback="Not yet. Check the target form, then type the full corrected sentence.">
  ...
  <h3>Rewrite the sentence so There is, There are is correct.</h3>
...
## Why It Matters
<p class="lesson-importance"><strong>&#127919; Why it matters:</strong> verb choices carry time, meaning, and attitude. One wrong form can change the whole message. When you control <u>There is, There are</u>, your writing and speaking become clearer, more natural, and more score-safe.</p>
