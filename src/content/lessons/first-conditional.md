...
## Real-World Examples with First conditional
...
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This correction matches the intended meaning and keeps First conditional natural.</p>
</article>
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This version sounds more natural because First conditional fits the sentence clearly.</p>
</article>
</div>

## Common Errors with First conditional
...
<button type="button" class="practice-chip" data-chip-value="If I" data-chip-origin="bank-1" data-chip-id="1-0">
  If I
</button>
<button type="button" class="practice-chip" data-chip-value="I would travel" data-chip-origin="bank-1" data-chip-id="1-1">
  I would travel
</button>
<button type="button" class="practice-chip" data-chip-value="this summer." data-chip-origin="bank-1" data-chip-id="1-2">
  this summer.
</button>
<button type="button" class="practice-chip" data-chip-value="had enough money," data-chip-origin="bank-1" data-chip-id="1-3">
  had enough money,
</button>
  </div>
