...
clb: "4-5"
exam: ["IELTS", "CELPIP"]
excerpt: "A2 grammar lesson on First conditional with unpacked explanations, aligned practice, and model answers."
date: "2026-02-27"
...
---
## Goal
Master **First conditional** with simple linked sentences.
...
Write 4 sentences using **First conditional**:
- one statement
...
Use **First conditional** at least twice and keep your logic clear.
