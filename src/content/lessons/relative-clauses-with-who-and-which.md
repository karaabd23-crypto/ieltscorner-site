---
title: "Relative clauses with who and which"
category: "grammar"
level: "A2"
ieltsBand: "4.0-5.0"
clb: "4-5"
...
quiz:
  ...
  - prompt: "Which edit fixes a common Relative clauses with who and which mistake?"
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Relative clauses with who and which error and matches the target form."
premium: false
priceCAD: 0
draft: false
---
<div class="lesson-context"><p class="lesson-context-lead"><strong>Relative clauses with who and which</strong> helps you add extra information about a person, thing, place, or idea without starting a whole new sentence. In this lesson, you will learn when the extra information is essential and how to connect it smoothly.</p></div>

## Examples
<p class="lesson-section-lede">&#10024; <strong>Read the examples first.</strong> They show the pattern for <u>Relative clauses with who and which</u> in real sentences.</p>
...
<article class="practice-task" data-task-type="choice" data-task-answer="1" data-task-id="0" data-correct-feedback="Correct. The better sentence keeps the intended meaning and the Relative clauses with who and which form fits naturally." data-wrong-feedback="Not yet. Check what the sentence really means before you choose the form.">
...
<article class="practice-task" data-task-type="typing" data-task-answers="The student who won the prize thanked her teacher." data-task-id="2" data-correct-feedback="Correct. You repaired the sentence without changing the message." data-wrong-feedback="Not yet. Check the target form, then type the full corrected sentence.">
  ...
  <h3>Rewrite the sentence so Relative clauses with who and which is correct.</h3>
...
## Why It Matters
<p class="lesson-importance"><strong>&#127919; Why it matters:</strong> longer grammar structures can raise your score only when they stay clear. When you control <u>Relative clauses with who and which</u>, you can add detail and shape the message without losing the reader halfway through the sentence.</p>
