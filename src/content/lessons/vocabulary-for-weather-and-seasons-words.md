...
---
## Goal
Use **Vocabulary for Weather and seasons words** vocabulary precisely with simple linked sentences.

## Concept Unpacked
Strong vocabulary performance is not about rare words; it is about choosing words and collocations that are semantically exact for the context. At A2, use clear examples plus one extension point.
...
- Does vocabulary meet A2 target: apply patterns in familiar contexts?
