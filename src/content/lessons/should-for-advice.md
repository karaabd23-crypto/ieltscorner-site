...
---
## Goal
Master **Should for advice** with simple linked sentences.
...
Write 4 sentences using **Should for advice**:
- one statement
...
Use **Should for advice** at least twice and keep your logic clear.
