...
<div class="lesson-resource-grid">
  <article class="lesson-resource-card">
    ...
    <ul><li>interested in: an adjective + preposition pair</li><li>responsible for: used with duties and roles</li><li>depend on: used for reliance</li><li>apologize for: used after saying sorry</li><li>on time: at the planned time</li><li>in advance: before something happens</li></ul>
  </article>
  <article class="lesson-resource-card">
    <p class="lesson-card-label">Useful chunks</p>
    <ul><li>interested in</li><li>responsible for</li><li>on time</li><li>in advance</li></ul>
  </article>
  <article class="lesson-resource-card">
    <p class="lesson-card-label">Sentence frames</p>
    <ul><li>She is interested in...</li><li>We arrived on time because...</li><li>Please submit the form in advance.</li></ul>
  </article>
</div>
