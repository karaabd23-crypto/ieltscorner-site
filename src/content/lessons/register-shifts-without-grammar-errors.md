...
---
## Goal
Master **Changing Formality Level** with maximum precision under time pressure.
...
Write 4 sentences using **Changing Formality Level**:
- one statement
...
Use **Changing Formality Level** at least twice and keep your logic clear.
