...
quiz:
  - prompt: "Which version uses Participle Clauses accurately?"
    options:
  ...
  - prompt: "Before you fix Participle Clauses in your answer, what comes first?"
    options:
  ...
  - prompt: "Which correction solves a common Participle Clauses slip?"
    options:
