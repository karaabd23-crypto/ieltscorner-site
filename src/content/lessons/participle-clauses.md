...
quiz:
  - prompt: "Which sentence uses Participle Clauses correctly?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 matches the main rule for Participle Clauses and keeps the sentence natural."
  - prompt: "What should you check first when editing Participle Clauses?"
    options:
  ...
  - prompt: "Which edit fixes a common Participle Clauses mistake?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Participle Clauses error and matches the target form."
premium: false
priceCAD: 0
draft: false
---
...
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This correction matches the intended meaning and keeps Participle Clauses natural.</p>
</article>
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This version sounds more natural because Participle Clauses fits the sentence clearly.</p>
</article>
</div>
