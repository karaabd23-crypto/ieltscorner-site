...
<div class="lesson-resource-grid">
  <article class="lesson-resource-card">
    ...
    <ul><li>itinerary: a travel plan or route</li><li>accommodation: a place to stay</li><li>departure: the act of leaving</li><li>destination: the place you are going to</li><li>delayed flight: a flight leaving later than planned</li><li>guided tour: a visit led by an expert</li></ul>
  </article>
  <article class="lesson-resource-card">
