...
clb: "5-6"
exam: ["IELTS", "CELPIP"]
excerpt: "Learn prepositions: other functions for B1 level. Clear explanations with practical examples and exercises for IELTS and CELPIP."
date: "2026-03-02"
...
This lesson explains Prepositions: Other Functions with practical patterns and examples, helping intermediate learners use English more accurately.
...
<tbody>
  <tr style="border: 1px solid #ddd;">
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><strong>Core preposition choice</strong></td>
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>The class starts at 9:00 and ends at 10:30.</em></td>
    <td style="padding: 0.75rem; border: 1px solid #ddd;">For standard place or time reference</td>
  </tr>
  <tr style="background: #fafafa; border: 1px solid #ddd;">
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><strong>Preposition in phrase</strong></td>
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>She is interested in public health and community work.</em></td>
    <td style="padding: 0.75rem; border: 1px solid #ddd;">In fixed collocations and expressions</td>
  </tr>
</tbody>
</table>
...
```
I use prepositions: other functions wrong in this sentence and it sound unclear.
```

### ✅ Correct

```
I used prepositions: other functions incorrectly in this sentence, so it sounded unclear.
```
...
> "In this sentence, prepositions: other functions is used accurately to express the intended meaning."

**Why this works:** It shows correct grammar control and clear communication.

### Example 2: CELPIP Speaking
> "I used prepositions: other functions in my response to make the message precise and natural."
