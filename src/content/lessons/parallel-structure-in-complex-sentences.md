...
quiz:
  - prompt: "Which sentence uses Matching Patterns in Sentences correctly?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 matches the main rule for Matching Patterns in Sentences and keeps the sentence natural."
  - prompt: "What should you check first when editing Matching Patterns in Sentences?"
    options:
  ...
  - prompt: "Which edit fixes a common Matching Patterns in Sentences mistake?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Matching Patterns in Sentences error and matches the target form."
premium: false
priceCAD: 0
draft: false
---
...
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This correction matches the intended meaning and keeps Matching Patterns in Sentences natural.</p>
</article>
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This version sounds more natural because Matching Patterns in Sentences fits the sentence clearly.</p>
</article>
</div>
