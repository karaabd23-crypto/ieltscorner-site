...
clb: "7-8"
exam: ["IELTS", "CELPIP"]
excerpt: "B2 lesson on Cleft Sentences with teacher-style explanation, guided practice, and topic-linked review."
date: "2026-03-02"
...
---
<div class="lesson-context"><p class="lesson-context-lead"><strong>Cleft Sentences</strong> changes the focus of the sentence. English can move words, repeat a pattern, or use a special structure to make one idea stand out more. In this lesson, you will learn how to add emphasis without sounding unnatural.</p></div>

## Examples
<p class="lesson-section-lede">&#10024; <strong>Read the examples first.</strong> They show the pattern for <u>Cleft Sentences</u> in real sentences.</p>
...
<article class="practice-task" data-task-type="choice" data-task-answer="1" data-task-id="0" data-correct-feedback="Correct. The better sentence keeps the intended meaning and the Cleft Sentences form fits naturally." data-wrong-feedback="Not yet. Check what the sentence really means before you choose the form.">
  <p class="practice-task-label">1. Quick pick</p>
  <h3>Choose the stronger sentence for Cleft Sentences.</h3>
...
<article class="practice-task" data-task-type="order" data-task-answer="What students need||most is clearer||feedback from||teachers." data-task-id="1" data-correct-feedback="Correct. The sentence now reads in a natural English order." data-wrong-feedback="Not yet. Build the sentence around the main subject and verb first.">
  ...
  <h3>Put this Cleft Sentences sentence in the correct order.</h3>
  <p class="practice-task-note">Tap a chunk to move it down. Tap it again to send it back.</p>
  <div class="practice-chip-bank" data-order-bank>
<button type="button" class="practice-chip" data-chip-value="teachers." data-chip-origin="bank-1" data-chip-id="1-0">
  teachers.
</button>
<button type="button" class="practice-chip" data-chip-value="What students need" data-chip-origin="bank-1" data-chip-id="1-1">
  What students need
</button>
<button type="button" class="practice-chip" data-chip-value="most is clearer" data-chip-origin="bank-1" data-chip-id="1-2">
  most is clearer
</button>
...
<article class="practice-task" data-task-type="typing" data-task-answers="Only then did the team understand the scale of the problem." data-task-id="2" data-correct-feedback="Correct. You repaired the sentence without changing the message." data-wrong-feedback="Not yet. Check the target form, then type the full corrected sentence.">
  ...
  <h3>Rewrite the sentence so Cleft Sentences is correct.</h3>
...
## Why It Matters
<p class="lesson-importance"><strong>&#127919; Why it matters:</strong> longer grammar structures can raise your score only when they stay clear. When you control <u>Cleft Sentences</u>, you can add detail and shape the message without losing the reader halfway through the sentence.</p>
