...
---
## Goal
Master **Non-defining relative clauses** with clear paragraph-level control.
...
Write 4 sentences using **Non-defining relative clauses**:
- one statement
...
Use **Non-defining relative clauses** at least twice and keep your logic clear.
