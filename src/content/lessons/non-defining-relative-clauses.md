...
clb: "6-7"
exam: ["IELTS", "CELPIP"]
excerpt: "B1 grammar lesson on Non-defining relative clauses with unpacked explanations, aligned practice, and model answers."
date: "2026-02-27"
...
---
## Goal
Learn how to use **Non-defining relative clauses** accurately in IELTS and CELPIP responses.

## What Non-defining relative clauses Means
This lesson is specifically about **Non-defining relative clauses**. By the end, you should understand when to use it, how to form it correctly, and how to avoid common errors.

## Topic Explanation and Use
Non-defining relative clauses controls how a sentence carries meaning: reference, sequence, and emphasis must stay clear from start to finish.

Use Non-defining relative clauses to make one precise meaning per sentence, then expand only when the added structure improves clarity for exam readers.
...
Reference examples:
- *In exam writing, accurate Non-defining relative clauses helps each sentence carry one clear grammatical purpose.*
- *When Non-defining relative clauses is chosen deliberately, arguments stay precise and easier to evaluate under time pressure.*

## Key Rule in Plain Language
1. Choose the exact grammar job first: where **Non-defining relative clauses** controls time, relationship, or emphasis.
2. Build a complete base clause, then place **Non-defining relative clauses** in the position required by the pattern.
3. Check agreement and tense around **Non-defining relative clauses** before adding extra words.
...
## Real-World Examples with Non-defining relative clauses
### Example 1
...
## Common Errors with Non-defining relative clauses
...
<details class="lesson-accordion lesson-error">
<summary>Error 3: adding complexity in Non-defining relative clauses without improving meaning</summary>

- Weak: *The writer attempts Non-defining relative clauses, but the sentence becomes difficult to follow due to unnecessary additions.*
- Strong: *The writer uses Non-defining relative clauses selectively, so the sentence remains clear and focused.*
...
Correct each sentence so it uses **Non-defining relative clauses** naturally.
...
Write 4 sentences that apply **Non-defining relative clauses** in public policy and daily life context.
- sentence 1: use **Non-defining relative clauses** to state one clear fact
- sentence 2: use **Non-defining relative clauses** to show contrast or qualification
- sentence 3: use **Non-defining relative clauses** to express cause and result
- sentence 4: use **Non-defining relative clauses** in an exam-style summary line
</details>
...
Use **Non-defining relative clauses** at least twice.
</details>
...
- place **Non-defining relative clauses** in a grammatically correct structure,
...
<article class="mini-quiz-card" data-answer="B">
<p class="mini-quiz-title">Q3. Choose the stronger version for: adding complexity in Non-defining relative clauses without improving meaning</p>
<div class="mini-quiz-options">
<button type="button" data-choice="A">A. The writer attempts Non-defining relative clauses, but the sentence becomes difficult to follow due to unnecessary additions.</button>
<button type="button" data-choice="B">B. The writer uses Non-defining relative clauses selectively, so the sentence remains clear and focused.</button>
</div>
<p class="mini-quiz-feedback" aria-live="polite"></p>
</article>
</div>
