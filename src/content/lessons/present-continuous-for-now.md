...
---
## Goal
Master **Present continuous for now** with simple sentence control.
...
Write 4 sentences using **Present continuous for now**:
- one statement
...
Use **Present continuous for now** at least twice and keep your logic clear.
