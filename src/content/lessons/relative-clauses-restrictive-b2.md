...
clb: "7-8"
exam: ["IELTS", "CELPIP"]
excerpt: "B2 grammar lesson on Relative Clauses: Restrictive with unpacked explanations, aligned practice, and model answers."
date: "2026-03-02"
...
---
## Goal
Master **Relative Clauses: Restrictive** with controlled complexity and clear logic chains.
...
Write 4 sentences using **Relative Clauses: Restrictive**:
- one statement
...
Use **Relative Clauses: Restrictive** at least twice and keep your logic clear.
