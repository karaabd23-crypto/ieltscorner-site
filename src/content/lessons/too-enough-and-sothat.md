...
clb: "6-7"
exam: ["IELTS", "CELPIP"]
excerpt: "B1 grammar lesson on Too, enough, and so...that with unpacked explanations, aligned practice, and model answers."
date: "2026-02-27"
...
---
## Goal
Master **Too, enough, and so...that** with clear paragraph-level control.
...
Write 4 sentences using **Too, enough, and so...that**:
- one statement
...
Use **Too, enough, and so...that** at least twice and keep your logic clear.
