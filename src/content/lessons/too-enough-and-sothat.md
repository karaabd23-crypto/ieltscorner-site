...
quiz:
  ...
  - prompt: "Which edit fixes a common Too, enough, and so...that mistake?"
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Too, enough, and so...that error and matches the target form."
premium: false
priceCAD: 0
draft: false
---
...
## Examples
<p class="lesson-section-lede">&#10024; <strong>Read the examples first.</strong> They show the pattern for <u>Too, enough, and so...that</u> in real sentences.</p>
