...
quiz:
  - prompt: "Which option shows Present Simple used correctly?"
    options:
  ...
  - prompt: "What is the first thing to settle when you work on Present Simple?"
    options:
  ...
  - prompt: "Which edit repairs a typical Present Simple error?"
    options:
...
---
<div class="lesson-context"><p class="lesson-context-lead"><strong>Present Simple</strong> is essential for expressing habitual actions, general truths, and scheduled events. Mastering this tense helps you communicate clearly about regular activities and facts.</p></div>
...
## Why It Matters
<p class="lesson-importance"><strong>&#127919; Why it matters:</strong> The Present Simple tense is foundational for clear communication about routines and facts. Mastering it enhances your ability to express consistency and truth in both writing and speaking.</p>
