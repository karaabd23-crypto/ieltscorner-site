...
---
## Goal
Master **Formal vs Informal Writing** for B2 (controlled complexity) performance in IELTS/CELPIP contexts.
...
Write one argumentative paragraph (6 sentences) using **Formal vs Informal Writing**.
Requirements:
- claim + counterpoint
...
## Level Deep Dive (B2)
At B2, your writing should show controlled development. Use Formal vs Informal Writing to build argument progression: claim, evidence, implication.
