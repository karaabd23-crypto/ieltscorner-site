...
clb: "7-8"
exam: ["IELTS", "CELPIP"]
excerpt: "Learn Formal vs Informal Writing for B2 with clear explanations, focused practice, and model answers."
date: "2026-03-02"
...
---
## Goal
Apply **Formal vs Informal Writing** to produce clearer, higher-scoring IELTS and CELPIP writing.

## What Formal vs Informal Writing Changes in Writing
This lesson is about using **Formal vs Informal Writing** to improve clarity, development, and control. Examiners reward writing that is direct, logical, and easy to follow.

## Topic Explanation and Use
Formal vs Informal Writing is a writing control skill that shapes how ideas are sequenced, supported, and interpreted by the reader.
...
1. Turn the prompt into one specific claim linked to **Formal vs Informal Writing**.
...
## Real-World Examples with Formal vs Informal Writing
### Example 1
...
## Common Errors with Formal vs Informal Writing
...
Write 5-6 sentences using **Formal vs Informal Writing**.
