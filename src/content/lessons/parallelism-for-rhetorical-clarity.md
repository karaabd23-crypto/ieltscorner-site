...
---
## Goal
Master **Parallelism for Clarity** with maximum precision under time pressure.
...
Write 4 sentences using **Parallelism for Clarity**:
- one statement
...
Use **Parallelism for Clarity** at least twice and keep your logic clear.
