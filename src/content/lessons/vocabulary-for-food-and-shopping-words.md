...
---
## Goal
Use **Vocabulary for Food and shopping words** vocabulary precisely with simple sentence control.

## Concept Unpacked
Strong vocabulary performance is not about rare words; it is about choosing words and collocations that are semantically exact for the context. At A1, use short, concrete explanations.
...
- Does vocabulary meet A1 target: recognize and apply core patterns accurately?
