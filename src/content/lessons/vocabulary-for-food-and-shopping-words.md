...
## Real-World Examples with Vocabulary for Food and shopping words
...
<div class="lesson-resource-grid">
  <article class="lesson-resource-card">
    ...
    <ul><li>fresh produce: fruit and vegetables</li><li>discount: a lower price than usual</li><li>receipt: proof of payment</li><li>budget-friendly: affordable in price</li><li>ingredient: one item used in cooking</li><li>out of stock: unavailable to buy now</li></ul>
  </article>
  <article class="lesson-resource-card">
...
## Common Errors with Vocabulary for Food and shopping words
