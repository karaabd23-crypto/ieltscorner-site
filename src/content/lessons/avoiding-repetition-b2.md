...
---
## Goal
Master **Avoiding Repetition in Writing** for B2 (controlled complexity) performance in IELTS/CELPIP contexts.
...
Write one argumentative paragraph (6 sentences) using **Avoiding Repetition in Writing**.
Requirements:
- claim + counterpoint
...
## Level Deep Dive (B2)
At B2, your writing should show controlled development. Use Avoiding Repetition in Writing to build argument progression: claim, evidence, implication.
