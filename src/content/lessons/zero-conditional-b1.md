...
---
<div class="lesson-context"><p class="lesson-context-lead"><strong>Zero conditional</strong> talks about things that are generally true. We use it for facts, rules, and routines. In this lesson, you will learn the pattern and see how it works in clear everyday examples.</p></div>

## Examples
<p class="lesson-section-lede">&#10024; <strong>Read the examples first.</strong> They show the pattern for <u>Zero conditional</u> in real sentences.</p>
<div class="lesson-example-grid">
<article class="lesson-example-card">
  <p class="lesson-card-label">Example 1</p>
  <p class="lesson-line lesson-line-weak"><span>Too weak</span>If people will drive too fast, accidents happen more often.</p>
...
<article class="lesson-example-card">
  ...
  <p class="lesson-line lesson-line-weak"><span>Too weak</span>If water reaches 100 degrees, it will boil.</p>
...
<article class="lesson-error-card">
  ...
  <p class="lesson-line lesson-line-weak"><span>Weak</span>If people will drive too fast, accidents happen more often.</p>
  <p class="lesson-line lesson-line-strong"><span>Strong</span>If people drive too fast, accidents happen more often.</p>
...
<article class="practice-task" data-task-type="choice" data-task-answer="1" data-task-id="0" data-correct-feedback="Correct. The better sentence keeps the intended meaning and the Zero conditional form fits naturally." data-wrong-feedback="Not yet. Check what the sentence really means before you choose the form.">
  <p class="practice-task-label">1. Quick pick</p>
  <h3>Choose the stronger sentence for Zero conditional.</h3>
...
<article class="practice-task" data-task-type="order" data-task-answer="If you heat||ice, it||melts." data-task-id="1" data-correct-feedback="Correct. The sentence now reads in a natural English order." data-wrong-feedback="Not yet. Build the sentence around the main subject and verb first.">
  <p class="practice-task-label">2. Build it</p>
  <h3>Put this Zero conditional sentence in the correct order.</h3>
  <p class="practice-task-note">Tap a chunk to move it down. Tap it again to send it back.</p>
  <div class="practice-chip-bank" data-order-bank>
<button type="button" class="practice-chip" data-chip-value="If you heat" data-chip-origin="bank-1" data-chip-id="1-0">
  If you heat
</button>
<button type="button" class="practice-chip" data-chip-value="melts." data-chip-origin="bank-1" data-chip-id="1-1">
  melts.
</button>
<button type="button" class="practice-chip" data-chip-value="ice, it" data-chip-origin="bank-1" data-chip-id="1-2">
  ice, it
</button>
  </div>
...
<article class="practice-task" data-task-type="typing" data-task-answers="If people don&#39;t sleep enough, they feel tired the next day." data-task-id="2" data-correct-feedback="Correct. You repaired the sentence without changing the message." data-wrong-feedback="Not yet. Check the target form, then type the full corrected sentence.">
  <p class="practice-task-label">3. Type the fix</p>
  <h3>Rewrite the sentence so Zero conditional is correct.</h3>
  <p class="practice-source-line"><span>Fix this:</span> If people don&#39;t sleep enough, they feeling tired the next day.</p>
...
<div class="practice-sort-row" data-sort-target="works" data-sort-row="0">
  <p>If students revise regularly, they remember more vocabulary.</p>
...
<div class="practice-sort-row" data-sort-target="fix" data-sort-row="1">
  <p>If students revise regularly, they will remember more vocabulary.</p>
  <div class="practice-sort-actions">
    <button type="button" class="practice-sort-btn" data-sort-choice="works">Works</button>
    <button type="button" class="practice-sort-btn" data-sort-choice="fix">Needs fixing</button>
  </div>
...
## Why It Matters
<p class="lesson-importance"><strong>&#127919; Why it matters:</strong> conditional sentences change the message fast. A small tense mistake can turn a fact into a future plan or an unreal idea into a real one. When you control <u>Zero conditional</u>, your meaning stays clear in speaking, writing, and exam answers.</p>
