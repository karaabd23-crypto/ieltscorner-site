...
quiz:
  - prompt: "Which sentence uses Adjectives in simple descriptions correctly?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 matches the main rule for Adjectives in simple descriptions and keeps the sentence natural."
  - prompt: "What should you check first when editing Adjectives in simple descriptions?"
    options:
  ...
  - prompt: "Which edit fixes a common Adjectives in simple descriptions mistake?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Adjectives in simple descriptions error and matches the target form."
premium: false
priceCAD: 0
draft: false
---
...
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This correction matches the intended meaning and keeps Adjectives in simple descriptions natural.</p>
</article>
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This version sounds more natural because Adjectives in simple descriptions fits the sentence clearly.</p>
</article>
</div>
