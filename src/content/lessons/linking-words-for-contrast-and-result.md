...
---
## Goal
Master **Linking words for contrast and result** with clear paragraph-level control.
...
Write 4 sentences using **Linking words for contrast and result**:
- one statement
...
Use **Linking words for contrast and result** at least twice and keep your logic clear.
