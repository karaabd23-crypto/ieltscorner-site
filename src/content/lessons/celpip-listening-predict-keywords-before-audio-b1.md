...
quiz:
  - prompt: "What matters most in CELPIP Listening: Predict Keywords Before the Audio?"
    options:
...
<button type="button" class="practice-chip" data-chip-value="Read the question and answer choices before the audio begins." data-chip-origin="bank-1" data-chip-id="1-0">
  Read the question and answer choices before the audio begins.
</button>
<button type="button" class="practice-chip" data-chip-value="Predict likely synonyms or paraphrases you may hear." data-chip-origin="bank-1" data-chip-id="1-1">
  Predict likely synonyms or paraphrases you may hear.
</button>
<button type="button" class="practice-chip" data-chip-value="Decide what information type the answer probably is." data-chip-origin="bank-1" data-chip-id="1-2">
  Decide what information type the answer probably is.
</button>
<button type="button" class="practice-chip" data-chip-value="Underline the key nouns and verbs." data-chip-origin="bank-1" data-chip-id="1-3">
...
<div class="practice-sort-row" data-sort-target="works" data-sort-row="0">
  <p>Read the question and answer choices before the audio begins.</p>
...
<div class="practice-sort-row" data-sort-target="works" data-sort-row="1">
  <p>Underline the key nouns and verbs.</p>
  <div class="practice-sort-actions">
    <button type="button" class="practice-sort-btn" data-sort-choice="works">Helpful</button>
    <button type="button" class="practice-sort-btn" data-sort-choice="fix">Not helpful</button>
  </div>
