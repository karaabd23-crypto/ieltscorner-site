...
clb: "2-3"
exam: ["IELTS", "CELPIP"]
excerpt: "A1 lesson on Imperatives for instructions with teacher-style explanation, guided practice, and topic-linked review."
date: "2026-02-27"
...
quiz:
  - prompt: "Which sentence uses Imperatives for instructions correctly?"
    options:
      - "You open the booklet and read question one."
      - "Open the booklet and read question one."
      - "Do not to forget your ID on test day."
    correctIndex: 1
    explanation: "Option 2 matches the main rule for Imperatives for instructions and keeps the sentence natural."
  - prompt: "What should you check first when editing Imperatives for instructions?"
    options:
  ...
  - prompt: "Which edit fixes a common Imperatives for instructions mistake?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Imperatives for instructions error and matches the target form."
premium: false
priceCAD: 0
draft: false
---
...
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This correction matches the intended meaning and keeps Imperatives for instructions natural.</p>
</article>
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This version sounds more natural because Imperatives for instructions fits the sentence clearly.</p>
</article>
</div>
...
<article class="practice-task" data-task-type="choice" data-task-answer="1" data-task-id="0" data-correct-feedback="Correct. The better sentence keeps the intended meaning and the Imperatives for instructions form fits naturally." data-wrong-feedback="Not yet. Check what the sentence really means before you choose the form.">
  <p class="practice-task-label">1. Quick pick</p>
  <h3>Choose the stronger sentence for Imperatives for instructions.</h3>
...
<article class="practice-task" data-task-type="order" data-task-answer="Don&#39;t be||late, and do||not bring your||phone inside." data-task-id="1" data-correct-feedback="Correct. The sentence now reads in a natural English order." data-wrong-feedback="Not yet. Build the sentence around the main subject and verb first.">
  <p class="practice-task-label">2. Build it</p>
  <h3>Put this Imperatives for instructions sentence in the correct order.</h3>
  <p class="practice-task-note">Tap a chunk to move it down. Tap it again to send it back.</p>
  <div class="practice-chip-bank" data-order-bank>
<button type="button" class="practice-chip" data-chip-value="not bring your" data-chip-origin="bank-1" data-chip-id="1-0">
  not bring your
</button>
<button type="button" class="practice-chip" data-chip-value="late, and do" data-chip-origin="bank-1" data-chip-id="1-1">
  late, and do
</button>
<button type="button" class="practice-chip" data-chip-value="Don&#39;t be" data-chip-origin="bank-1" data-chip-id="1-2">
  Don&#39;t be
</button>
<button type="button" class="practice-chip" data-chip-value="phone inside." data-chip-origin="bank-1" data-chip-id="1-3">
  phone inside.
</button>
  </div>
...
<article class="practice-task" data-task-type="typing" data-task-answers="Read the prompt carefully and underline the key verb." data-task-id="2" data-correct-feedback="Correct. You repaired the sentence without changing the message." data-wrong-feedback="Not yet. Check the target form, then type the full corrected sentence.">
  <p class="practice-task-label">3. Type the fix</p>
  <h3>Rewrite the sentence so Imperatives for instructions is correct.</h3>
  <p class="practice-source-line"><span>Fix this:</span> Read the prompt carefully and underline the key verb.</p>
...
<div class="practice-sort-row" data-sort-target="works" data-sort-row="0">
  <p>Please check the heading before you write.</p>
...
<div class="practice-sort-row" data-sort-target="fix" data-sort-row="1">
  <p>Please to check the heading before you write.</p>
  <div class="practice-sort-actions">
    <button type="button" class="practice-sort-btn" data-sort-choice="works">Works</button>
    <button type="button" class="practice-sort-btn" data-sort-choice="fix">Needs fixing</button>
  </div>
...
<div class="practice-sort-row" data-sort-target="works" data-sort-row="2">
  <p>Don&#39;t be late, and do not bring your phone inside.</p>
  <div class="practice-sort-actions">
    <button type="button" class="practice-sort-btn" data-sort-choice="works">Works</button>
    <button type="button" class="practice-sort-btn" data-sort-choice="fix">Needs fixing</button>
  </div>
...
<div class="practice-sort-row" data-sort-target="fix" data-sort-row="3">
  <p>Don&#39;t be late and bring not your phone inside.</p>
  <div class="practice-sort-actions">
    <button type="button" class="practice-sort-btn" data-sort-choice="works">Works</button>
    <button type="button" class="practice-sort-btn" data-sort-choice="fix">Needs fixing</button>
  </div>
