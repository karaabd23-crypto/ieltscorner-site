...
quiz:
  ...
  - prompt: "Which edit fixes a common Using Abstract Nouns mistake?"
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Using Abstract Nouns error and matches the target form."
premium: false
priceCAD: 0
draft: false
---
...
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This correction matches the intended meaning and keeps Abstract Nouns natural.</p>
</article>
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This version sounds more natural because Abstract Nouns fits the sentence clearly.</p>
</article>
</div>
