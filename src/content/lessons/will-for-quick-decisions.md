...
quiz:
  - prompt: "Which option shows Will for quick decisions used correctly?"
    options:
  ...
  - prompt: "Before you fix Will for quick decisions in your answer, what comes first?"
    options:
  ...
  - prompt: "Which correction solves a common Will for quick decisions slip?"
    options:
