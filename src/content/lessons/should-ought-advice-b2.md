...
---
## Goal
Master **Should, Ought To, Must (Advice)** with controlled complexity and clear logic chains.
...
Write 4 sentences using **Should, Ought To, Must (Advice)**:
- one statement
...
Use **Should, Ought To, Must (Advice)** at least twice and keep your logic clear.
