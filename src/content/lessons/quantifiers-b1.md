...
<div class="lesson-resource-grid">
  <article class="lesson-resource-card">
    ...
    <ul><li>many: used with countable plural nouns</li><li>much: used with uncountable nouns</li><li>a few: a small positive number</li><li>a little: a small positive amount</li><li>plenty of: more than enough</li><li>not much: a small amount in negative meaning</li></ul>
  </article>
  <article class="lesson-resource-card">
    <p class="lesson-card-label">Useful chunks</p>
    <ul><li>many reasons</li><li>much time</li><li>a few students</li><li>a little money</li></ul>
  </article>
  <article class="lesson-resource-card">
    <p class="lesson-card-label">Sentence frames</p>
    <ul><li>There are many...</li><li>We have very little...</li><li>Only a few people...</li></ul>
  </article>
</div>
