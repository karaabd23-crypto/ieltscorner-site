...
quiz:
  - prompt: "Which sentence uses Past Simple: Regular Verbs correctly?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 matches the main rule for Past Simple: Regular Verbs and keeps the sentence natural."
  - prompt: "What should you check first when editing Past Simple: Regular Verbs?"
    options:
  ...
  - prompt: "Which edit fixes a common Past Simple: Regular Verbs mistake?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Past Simple: Regular Verbs error and matches the target form."
premium: false
priceCAD: 0
draft: false
---
...
## Examples
<p class="lesson-section-lede">&#10024; <strong>Read the examples first.</strong> They show the pattern for <u>Past Simple</u> in real sentences.</p>
...
<article class="practice-task" data-task-type="choice" data-task-answer="1" data-task-id="0" data-correct-feedback="Correct. The better sentence keeps the intended meaning and the Past Simple form fits naturally." data-wrong-feedback="Not yet. Check what the sentence really means before you choose the form.">
...
<article class="practice-task" data-task-type="typing" data-task-answers="By the end of this year, the city will reduce emissions by 10 percent." data-task-id="2" data-correct-feedback="Correct. You repaired the sentence without changing the message." data-wrong-feedback="Not yet. Check the target form, then type the full corrected sentence.">
  ...
  <h3>Rewrite the sentence so Past Simple is correct.</h3>
...
## Why It Matters
<p class="lesson-importance"><strong>&#127919; Why it matters:</strong> verb choices carry time, meaning, and attitude. One wrong form can change the whole message. When you control <u>Past Simple</u>, your writing and speaking become clearer, more natural, and more score-safe.</p>
