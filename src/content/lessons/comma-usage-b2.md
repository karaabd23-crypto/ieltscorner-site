...
---
## Goal
Master **Comma Usage** for B2 (controlled complexity) performance in IELTS/CELPIP contexts.
...
Write one argumentative paragraph (6 sentences) using **Comma Usage**.
Requirements:
- claim + counterpoint
...
## Level Deep Dive (B2)
At B2, your writing should show controlled development. Use Comma Usage to build argument progression: claim, evidence, implication.
