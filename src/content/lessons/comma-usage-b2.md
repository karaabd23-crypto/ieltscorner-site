...
---
<div class="lesson-context"><p class="lesson-context-lead"><strong>Comma Usage</strong> is a writing skill for IELTS and CELPIP. This lesson shows what the skill does, what a strong response looks like, and what to check before you finish your answer.</p></div>

## Examples
<p class="lesson-section-lede">&#10024; <strong>Read the examples first.</strong> They show the pattern for <u>Comma Usage</u> in real sentences.</p>
...
<article class="practice-task" data-task-type="choice" data-task-answer="1" data-task-id="0">
  ...
  <h3>Choose the stronger move for Comma Usage.</h3>
