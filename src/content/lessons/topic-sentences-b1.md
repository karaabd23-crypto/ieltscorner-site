...
---
## Goal
Master **Topic Sentences and Supporting Details** for B1 (clear control) performance in IELTS/CELPIP contexts.
...
Write one paragraph (5 sentences) about a common social topic using **Topic Sentences and Supporting Details**.
Requirements:
- one clear claim
- one support reason
- one specific example
...
## Level Deep Dive (B1)
At B1, you should manage paragraph unity. Use Topic Sentences and Supporting Details to support one central point with simple but clear logic.
