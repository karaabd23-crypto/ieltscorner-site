---
title: "Topic Sentences and Supporting Details (B1)"
category: "writing"
level: "B1"
ieltsBand: "4.5-5.5"
clb: "5-6"
exam: ["IELTS", "CELPIP"]
excerpt: "Learn topic sentences and supporting details for B1 level. Clear explanations with practical examples and exercises for IELTS and CELPIP."
date: "2026-03-02"
...
This lesson explains how to use Topic Sentences and Supporting Details in clear written English, helping intermediate learners produce stronger task responses.
...
<tbody>
  <tr style="border: 1px solid #ddd;">
    ...
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>This paragraph uses topic sentences and supporting details to present one main idea clearly.</em></td>
  ...
  <tr style="background: #fafafa; border: 1px solid #ddd;">
    ...
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>In formal tasks, topic sentences and supporting details helps connect claims and evidence logically.</em></td>
...
```
I use topic sentences and supporting details wrong in this sentence and it sound unclear.
```

### ✅ Correct

```
I used topic sentences and supporting details incorrectly in this sentence, so it sounded unclear.
```
...
> "Overall, the data shows that topic sentences and supporting details plays a key role in the final trend."

**Why this works:** It applies topic sentences and supporting details in a formal IELTS style with a clear claim.

### Example 2: CELPIP Speaking
> "In my opinion, using topic sentences and supporting details makes this response clearer and more organized."

**Why this works:** It uses topic sentences and supporting details to present a direct opinion plus support.
