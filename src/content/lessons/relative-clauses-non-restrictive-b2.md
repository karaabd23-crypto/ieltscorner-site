---
title: "Relative Clauses: Non-restrictive (B2)"
category: "grammar"
level: "B2"
ieltsBand: "6.0-7.0"
clb: "7-8"
exam: ["IELTS", "CELPIP"]
excerpt: "B2 grammar lesson on Relative Clauses: Non-restrictive with unpacked explanations, aligned practice, and model answers."
date: "2026-03-02"
...
---
## Goal
Learn how to use **Relative Clauses: Non-restrictive** accurately in IELTS and CELPIP responses.

## What Relative Clauses: Non-restrictive Means
This lesson is specifically about **Relative Clauses: Non-restrictive**. By the end, you should understand when to use it, how to form it correctly, and how to avoid common errors.

## Topic Explanation and Use
Relative Clauses: Non-restrictive controls how a sentence carries meaning: reference, sequence, and emphasis must stay clear from start to finish.

Use Relative Clauses: Non-restrictive to make one precise meaning per sentence, then expand only when the added structure improves clarity for exam readers.
...
## Real-World Examples with Relative Clauses: Non-restrictive
### Example 1
...
## Common Errors with Relative Clauses: Non-restrictive
...
<details class="lesson-accordion lesson-error">
<summary>Error 3: adding complexity in Relative Clauses: Non-restrictive without improving meaning</summary>

- Weak: *The writer attempts Relative Clauses: Non-restrictive, but the sentence becomes difficult to follow due to unnecessary additions.*
- Strong: *The writer uses Relative Clauses: Non-restrictive selectively, so the sentence remains clear and focused.*
...
Correct each sentence so it uses **Relative Clauses: Non-restrictive** naturally.
...
Write 4 sentences that apply **Relative Clauses: Non-restrictive** in public policy and daily life context.
...
<article class="mini-quiz-card" data-answer="B">
<p class="mini-quiz-title">Q3. Choose the stronger version for: adding complexity in Relative Clauses: Non-restrictive without improving meaning</p>
<div class="mini-quiz-options">
<button type="button" data-choice="A">A. The writer attempts Relative Clauses: Non-restrictive, but the sentence becomes difficult to follow due to unnecessary additions.</button>
<button type="button" data-choice="B">B. The writer uses Relative Clauses: Non-restrictive selectively, so the sentence remains clear and focused.</button>
</div>
<p class="mini-quiz-feedback" aria-live="polite"></p>
</article>
</div>
