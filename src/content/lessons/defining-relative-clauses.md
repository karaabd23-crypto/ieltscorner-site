...
---
## Goal
Master **Defining relative clauses** with clear paragraph-level control.
...
Write 4 sentences using **Defining relative clauses**:
- one statement
...
Use **Defining relative clauses** at least twice and keep your logic clear.
