...
quiz:
  - prompt: "Which sentence uses Defining relative clauses correctly?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 matches the main rule for Defining relative clauses and keeps the sentence natural."
  - prompt: "What should you check first when editing Defining relative clauses?"
    options:
  ...
  - prompt: "Which edit fixes a common Defining relative clauses mistake?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Defining relative clauses error and matches the target form."
premium: false
priceCAD: 0
draft: false
---
<div class="lesson-context"><p class="lesson-context-lead"><strong>Defining relative clauses</strong> helps you add extra information about a person, thing, place, or idea without starting a whole new sentence. In this lesson, you will learn when the extra information is essential and how to connect it smoothly.</p></div>

## Examples
<p class="lesson-section-lede">&#10024; <strong>Read the examples first.</strong> They show the pattern for <u>Defining relative clauses</u> in real sentences.</p>
...
<article class="practice-task" data-task-type="choice" data-task-answer="1" data-task-id="0" data-correct-feedback="Correct. The better sentence keeps the intended meaning and the Defining relative clauses form fits naturally." data-wrong-feedback="Not yet. Check what the sentence really means before you choose the form.">
  <p class="practice-task-label">1. Quick pick</p>
  <h3>Choose the stronger sentence for Defining relative clauses.</h3>
...
<article class="practice-task" data-task-type="order" data-task-answer="People who||live near stations||often use public||transport more." data-task-id="1" data-correct-feedback="Correct. The sentence now reads in a natural English order." data-wrong-feedback="Not yet. Build the sentence around the main subject and verb first.">
  ...
  <h3>Put this Defining relative clauses sentence in the correct order.</h3>
...
<article class="practice-task" data-task-type="typing" data-task-answers="The student who won the prize thanked her teacher." data-task-id="2" data-correct-feedback="Correct. You repaired the sentence without changing the message." data-wrong-feedback="Not yet. Check the target form, then type the full corrected sentence.">
  ...
  <h3>Rewrite the sentence so Defining relative clauses is correct.</h3>
...
## Why It Matters
<p class="lesson-importance"><strong>&#127919; Why it matters:</strong> longer grammar structures can raise your score only when they stay clear. When you control <u>Defining relative clauses</u>, you can add detail and shape the message without losing the reader halfway through the sentence.</p>
