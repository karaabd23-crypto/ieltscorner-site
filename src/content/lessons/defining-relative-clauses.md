...
clb: "6-7"
exam: ["IELTS", "CELPIP"]
excerpt: "B1 grammar lesson on Defining relative clauses with unpacked explanations, aligned practice, and model answers."
date: "2026-02-27"
...
---
## Goal
Learn how to use **Defining relative clauses** accurately in IELTS and CELPIP responses.

## What Defining relative clauses Means
This lesson is specifically about **Defining relative clauses**. By the end, you should understand when to use it, how to form it correctly, and how to avoid common errors.

## Topic Explanation and Use
Defining relative clauses controls how a sentence carries meaning: reference, sequence, and emphasis must stay clear from start to finish.

Use Defining relative clauses to make one precise meaning per sentence, then expand only when the added structure improves clarity for exam readers.
...
Reference examples:
- *In exam writing, accurate Defining relative clauses helps each sentence carry one clear grammatical purpose.*
- *When Defining relative clauses is chosen deliberately, arguments stay precise and easier to evaluate under time pressure.*

## Key Rule in Plain Language
1. Choose the exact grammar job first: where **Defining relative clauses** controls time, relationship, or emphasis.
2. Build a complete base clause, then place **Defining relative clauses** in the position required by the pattern.
3. Check agreement and tense around **Defining relative clauses** before adding extra words.
...
## Real-World Examples with Defining relative clauses
### Example 1
...
## Common Errors with Defining relative clauses
...
<details class="lesson-accordion lesson-error">
<summary>Error 3: adding complexity in Defining relative clauses without improving meaning</summary>

- Weak: *The writer attempts Defining relative clauses, but the sentence becomes difficult to follow due to unnecessary additions.*
- Strong: *The writer uses Defining relative clauses selectively, so the sentence remains clear and focused.*
...
Correct each sentence so it uses **Defining relative clauses** naturally.
...
Write 4 sentences that apply **Defining relative clauses** in public policy and daily life context.
- sentence 1: use **Defining relative clauses** to state one clear fact
- sentence 2: use **Defining relative clauses** to show contrast or qualification
- sentence 3: use **Defining relative clauses** to express cause and result
- sentence 4: use **Defining relative clauses** in an exam-style summary line
</details>
...
Use **Defining relative clauses** at least twice.
</details>
...
- place **Defining relative clauses** in a grammatically correct structure,
...
<article class="mini-quiz-card" data-answer="B">
<p class="mini-quiz-title">Q3. Choose the stronger version for: adding complexity in Defining relative clauses without improving meaning</p>
<div class="mini-quiz-options">
<button type="button" data-choice="A">A. The writer attempts Defining relative clauses, but the sentence becomes difficult to follow due to unnecessary additions.</button>
<button type="button" data-choice="B">B. The writer uses Defining relative clauses selectively, so the sentence remains clear and focused.</button>
</div>
<p class="mini-quiz-feedback" aria-live="polite"></p>
</article>
</div>
