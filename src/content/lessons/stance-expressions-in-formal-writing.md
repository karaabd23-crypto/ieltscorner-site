...
quiz:
  - prompt: "Which sentence uses Showing Your Opinion Clearly correctly?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 matches the main rule for Showing Your Opinion Clearly and keeps the sentence natural."
  - prompt: "What should you check first when editing Showing Your Opinion Clearly?"
    options:
  ...
  - prompt: "Which edit fixes a common Showing Your Opinion Clearly mistake?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Showing Your Opinion Clearly error and matches the target form."
premium: true
priceCAD: 12
draft: false
---
...
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This correction matches the intended meaning and keeps Showing Your Opinion Clearly natural.</p>
</article>
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This version sounds more natural because Showing Your Opinion Clearly fits the sentence clearly.</p>
</article>
</div>
...
<article class="practice-task" data-task-type="choice" data-task-answer="1" data-task-id="0" data-correct-feedback="Correct. The better sentence keeps the intended meaning and the Showing Your Opinion Clearly form fits naturally." data-wrong-feedback="Not yet. Check what the sentence really means before you choose the form.">
...
<article class="practice-task" data-task-type="typing" data-task-answers="This suggests the project could benefit many communities." data-task-id="2" data-correct-feedback="Correct. You repaired the sentence without changing the message." data-wrong-feedback="Not yet. Check the target form, then type the full corrected sentence.">
  ...
  <h3>Rewrite the sentence so Showing Your Opinion Clearly is correct.</h3>
