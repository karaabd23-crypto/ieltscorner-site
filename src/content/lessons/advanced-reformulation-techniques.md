...
---
## Goal
Master **Rephrasing for Variety** with maximum precision under time pressure.
...
Write 4 sentences using **Rephrasing for Variety**:
- one statement
...
Use **Rephrasing for Variety** at least twice and keep your logic clear.
