...
clb: "7-8"
exam: ["IELTS", "CELPIP"]
excerpt: "Learn direct and indirect speech for B2 level. Clear explanations with practical examples and exercises for IELTS and CELPIP."
date: "2026-03-02"
...
This lesson explains Direct and Indirect Speech with practical patterns and examples, helping intermediate learners use English more accurately.
...
<tbody>
  <tr style="border: 1px solid #ddd;">
    ...
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>Students use direct and indirect speech to build clear intermediate level sentences.</em></td>
  ...
  <tr style="background: #fafafa; border: 1px solid #ddd;">
    ...
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>This pattern helps learners use direct and indirect speech with better precision and control.</em></td>
...
```
I use direct and indirect speech wrong in this sentence and it sound unclear.
```

### ✅ Correct

```
I used direct and indirect speech incorrectly in this sentence, so it sounded unclear.
```
...
> "In this sentence, direct and indirect speech is used accurately to express the intended meaning."

**Why this works:** It shows correct grammar control and clear communication.

### Example 2: CELPIP Speaking
> "I used direct and indirect speech in my response to make the message precise and natural."
