...
clb: "4-5"
exam: ["IELTS", "CELPIP"]
excerpt: "A2 grammar lesson on Must and have to with unpacked explanations, aligned practice, and model answers."
date: "2026-02-27"
...
---
## Goal
Master **Must and have to** with simple linked sentences.
...
Write 4 sentences using **Must and have to**:
- one statement
...
Use **Must and have to** at least twice and keep your logic clear.
