...
clb: "5-6"
exam: ["IELTS", "CELPIP"]
excerpt: "Learn there is, there are for B1 level. Clear explanations with practical examples and exercises for IELTS and CELPIP."
date: "2026-03-02"
...
This lesson explains There is, There are with practical patterns and examples, helping intermediate learners use English more accurately.
...
<tbody>
  <tr style="border: 1px solid #ddd;">
    ...
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>Students use there is, there are to build clear intermediate level sentences.</em></td>
