---
title: "Collocations: Common Phrases (B1)"
category: "vocabulary"
level: "B1"
ieltsBand: "4.5-5.5"
clb: "5-6"
exam: ["IELTS", "CELPIP"]
excerpt: "B1 vocabulary lesson on Collocations: Common Phrases with a practical word bank, collocations, and retrieval practice."
date: "2026-03-02"
...
---
<div class="lesson-context"><p class="lesson-context-lead"><strong>Collocations: Common Phrases</strong> is about the words and phrases you need for real English. This lesson shows what the key words mean, where they fit, and how to use them in natural sentences without sounding forced.</p></div>

## Examples
<p class="lesson-section-lede">&#10024; <strong>Read the examples first.</strong> They show the pattern for <u>Collocations: Common Phrases</u> in real sentences.</p>
...
<p>Collocations: Common Phrases teaches natural word partnerships such as make progress and take responsibility.</p>
<p>Use these phrases to sound natural and efficient. English often prefers one fixed word partnership, even when other combinations seem logical.</p>
<p>At B1 level, learn fewer words but learn them well: meaning, collocation, and one model sentence.</p>
  ...
  <section class="lesson-panel lesson-panel-when">
    ...
    <ul><li>Study the whole phrase, not only the head word.</li><li>Check whether English uses make, do, take, or another partner.</li><li>Reuse the collocation in a complete sentence soon after learning it.</li></ul>
  </section>
  <section class="lesson-panel lesson-panel-pattern">
    <p class="lesson-panel-label">Watch it work</p>
    <div class="lesson-pattern-stack"><div class="lesson-pattern-sentence">Students make progress when they review consistently.</div>
<div class="lesson-pattern-sentence">Teams take responsibility for checking the final draft.</div></div>
  </section>
...
<div class="practice-lab" data-practice-lab>
  <div class="practice-lab-head">
    <div>
      <h3>Practice</h3>
      <p class="practice-lab-intro">Start with meaning. Then move to collocations and sentence control for Collocations: Common Phrases.</p>
    </div>
...
<article class="practice-task" data-task-type="order" data-task-answer="Make progress works||best when the||meaning is clear||in the||sentence." data-task-id="1">
...
<button type="button" class="practice-chip" data-chip-value="Make progress works" data-chip-origin="bank-1" data-chip-id="1-0">
  Make progress works
</button>
...
<article class="practice-task" data-task-type="typing" data-task-answers="progress" data-task-id="2">
  <p class="practice-task-label">3. Type the missing word</p>
  <h3>Complete the useful chunk: make _____</h3>
  <p class="practice-source-line"><span>Fix this:</span> make progress: move forward successfully</p>
...
## Why It Matters
<p class="lesson-importance"><strong>&#127919; Why it matters:</strong> good vocabulary is not just about knowing a word. You need the <em>right</em> word in the <em>right</em> sentence. When you control Collocations: Common Phrases, you sound clearer, more natural, and more precise in real English.</p>
