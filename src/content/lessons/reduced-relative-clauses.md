...
## Real-World Examples with Short Relative Clauses
...
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This correction matches the intended meaning and keeps Short Relative Clauses natural.</p>
</article>
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This version sounds more natural because Short Relative Clauses fits the sentence clearly.</p>
</article>
</div>

## Common Errors with Short Relative Clauses
...
<button type="button" class="practice-chip" data-chip-value="transport more." data-chip-origin="bank-1" data-chip-id="1-1">
  transport more.
</button>
