...
clb: "7-8"
exam: ["IELTS", "CELPIP"]
excerpt: "B2 grammar lesson on Short Relative Clauses with unpacked explanations, aligned practice, and model answers."
date: "2026-02-27"
...
---
## Goal
Master **Short Relative Clauses** with controlled complexity and clear logic chains.
...
Write 4 sentences using **Short Relative Clauses**:
- one statement
...
Use **Short Relative Clauses** at least twice and keep your logic clear.
