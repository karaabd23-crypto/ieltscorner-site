...
quiz:
  ...
  - prompt: "Which edit fixes a common Verb + gerund (ing form) mistake?"
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Verb + gerund (ing form) error and matches the target form."
premium: false
priceCAD: 0
draft: false
---
<div class="lesson-context"><p class="lesson-context-lead"><strong>Verb + gerund (ing form)</strong> is about the verb form that comes next. Some words are followed by <em>-ing</em>, some by <em>to + verb</em>, and some change meaning when the form changes. In this lesson, you will learn how to choose the right pattern with confidence.</p></div>

## Examples
<p class="lesson-section-lede">&#10024; <strong>Read the examples first.</strong> They show the pattern for <u>Verb + gerund (ing form)</u> in real sentences.</p>
...
<article class="practice-task" data-task-type="choice" data-task-answer="1" data-task-id="0" data-correct-feedback="Correct. The better sentence keeps the intended meaning and the Verb + gerund (ing form) form fits naturally." data-wrong-feedback="Not yet. Check what the sentence really means before you choose the form.">
...
<article class="practice-task" data-task-type="typing" data-task-answers="The manager admitted making a planning mistake." data-task-id="2" data-correct-feedback="Correct. You repaired the sentence without changing the message." data-wrong-feedback="Not yet. Check the target form, then type the full corrected sentence.">
  ...
  <h3>Rewrite the sentence so Verb + gerund (ing form) is correct.</h3>
...
## Why It Matters
<p class="lesson-importance"><strong>&#127919; Why it matters:</strong> verb choices carry time, meaning, and attitude. One wrong form can change the whole message. When you control <u>Verb + gerund (ing form)</u>, your writing and speaking become clearer, more natural, and more score-safe.</p>
