...
clb: "4-5"
exam: ["IELTS", "CELPIP"]
excerpt: "A2 grammar lesson on Verb + gerund (ing form) with unpacked explanations, aligned practice, and model answers."
date: "2026-02-27"
...
---
## Goal
Master **Verb + gerund (ing form)** with simple linked sentences.
...
Write 4 sentences using **Verb + gerund (ing form)**:
- one statement
...
Use **Verb + gerund (ing form)** at least twice and keep your logic clear.
