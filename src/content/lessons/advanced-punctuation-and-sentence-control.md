...
quiz:
  ...
  - prompt: "Which edit fixes a common Punctuation and Sentence Control mistake?"
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Punctuation and Sentence Control error and matches the target form."
premium: true
priceCAD: 12
draft: false
---
...
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This correction matches the intended meaning and keeps Punctuation and Sentence Control natural.</p>
</article>
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This version sounds more natural because Punctuation and Sentence Control fits the sentence clearly.</p>
</article>
</div>
...
<button type="button" class="practice-chip" data-chip-value="She has one" data-chip-origin="bank-1" data-chip-id="1-1">
  She has one
</button>
<button type="button" class="practice-chip" data-chip-value="safety near" data-chip-origin="bank-1" data-chip-id="1-2">
  safety near
</button>
