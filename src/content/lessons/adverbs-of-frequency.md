...
clb: "4-5"
exam: ["IELTS", "CELPIP"]
excerpt: "A2 lesson on Adverbs of frequency with teacher-style explanation, guided practice, and topic-linked review."
date: "2026-02-27"
...
<button type="button" class="practice-chip" data-chip-value="the chart clearly" data-chip-origin="bank-1" data-chip-id="1-0">
  the chart clearly
</button>
<button type="button" class="practice-chip" data-chip-value="and briefly." data-chip-origin="bank-1" data-chip-id="1-1">
  and briefly.
</button>
<button type="button" class="practice-chip" data-chip-value="He explained" data-chip-origin="bank-1" data-chip-id="1-2">
  He explained
</button>
  </div>
