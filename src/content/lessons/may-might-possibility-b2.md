...
clb: "7-8"
exam: ["IELTS", "CELPIP"]
excerpt: "Learn may, might, could for possibility for B2 level. Clear explanations with practical examples and exercises for IELTS and CELPIP."
date: "2026-03-02"
...
This lesson explains May, Might, Could for Possibility with practical patterns and examples, helping intermediate learners use English more accurately.
...
```
I use may, might, could for possibility wrong in this sentence and it sound unclear.
```

### ✅ Correct

```
I used may, might, could for possibility incorrectly in this sentence, so it sounded unclear.
```
...
> "In this sentence, may, might, could for possibility is used accurately to express the intended meaning."

**Why this works:** It shows correct grammar control and clear communication.

### Example 2: CELPIP Speaking
> "I used may, might, could for possibility in my response to make the message precise and natural."
