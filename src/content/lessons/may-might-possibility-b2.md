...
quiz:
  - prompt: "Which sentence uses May, Might, Could for Possibility correctly?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 matches the main rule for May, Might, Could for Possibility and keeps the sentence natural."
  - prompt: "What should you check first when editing May, Might, Could for Possibility?"
    options:
  ...
  - prompt: "Which edit fixes a common May, Might, Could for Possibility mistake?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical May, Might, Could for Possibility error and matches the target form."
---
<div class="lesson-context"><p class="lesson-context-lead"><strong>May, Might, Could for Possibility</strong> helps you show ideas like advice, ability, possibility, or obligation. The word may look small, but it changes the whole meaning of the sentence. In this lesson, you will learn which form fits which message.</p></div>

## Examples
<p class="lesson-section-lede">&#10024; <strong>Read the examples first.</strong> They show the pattern for <u>May, Might, Could for Possibility</u> in real sentences.</p>
...
<article class="practice-task" data-task-type="choice" data-task-answer="1" data-task-id="0" data-correct-feedback="Correct. The better sentence keeps the intended meaning and the May, Might, Could for Possibility form fits naturally." data-wrong-feedback="Not yet. Check what the sentence really means before you choose the form.">
  <p class="practice-task-label">1. Quick pick</p>
  <h3>Choose the stronger sentence for May, Might, Could for Possibility.</h3>
...
<article class="practice-task" data-task-type="order" data-task-answer="Residents should stay||home tonight because||the storm may||be severe." data-task-id="1" data-correct-feedback="Correct. The sentence now reads in a natural English order." data-wrong-feedback="Not yet. Build the sentence around the main subject and verb first.">
  ...
  <h3>Put this May, Might, Could for Possibility sentence in the correct order.</h3>
...
<article class="practice-task" data-task-type="typing" data-task-answers="She might finish early if the meeting is short." data-task-id="2" data-correct-feedback="Correct. You repaired the sentence without changing the message." data-wrong-feedback="Not yet. Check the target form, then type the full corrected sentence.">
  ...
  <h3>Rewrite the sentence so May, Might, Could for Possibility is correct.</h3>
...
## Why It Matters
<p class="lesson-importance"><strong>&#127919; Why it matters:</strong> verb choices carry time, meaning, and attitude. One wrong form can change the whole message. When you control <u>May, Might, Could for Possibility</u>, your writing and speaking become clearer, more natural, and more score-safe.</p>
