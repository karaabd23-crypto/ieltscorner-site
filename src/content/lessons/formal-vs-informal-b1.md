...
clb: "5-6"
exam: ["IELTS", "CELPIP"]
excerpt: "Learn formal vs informal writing for B1 level. Clear explanations with practical examples and exercises for IELTS and CELPIP."
date: "2026-03-02"
...
This lesson explains how to use Formal vs Informal Writing in clear written English, helping intermediate learners produce stronger task responses.
...
<tbody>
  <tr style="border: 1px solid #ddd;">
    ...
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>This paragraph uses formal vs informal writing to present one main idea clearly.</em></td>
  ...
  <tr style="background: #fafafa; border: 1px solid #ddd;">
    ...
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>In formal tasks, formal vs informal writing helps connect claims and evidence logically.</em></td>
...
```
I use formal vs informal writing wrong in this sentence and it sound unclear.
```

### ✅ Correct

```
I used formal vs informal writing incorrectly in this sentence, so it sounded unclear.
```
...
> "Overall, the data shows that formal vs informal writing plays a key role in the final trend."

**Why this works:** It applies formal vs informal writing in a formal IELTS style with a clear claim.

### Example 2: CELPIP Speaking
> "In my opinion, using formal vs informal writing makes this response clearer and more organized."

**Why this works:** It uses formal vs informal writing to present a direct opinion plus support.
