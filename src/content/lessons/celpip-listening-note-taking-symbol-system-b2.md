...
quiz:
  - prompt: "What is the best note-taking style for CELPIP listening?"
    options:
      ...
      - "Use short symbols and keywords"
      - "Write only numbers"
      - "Do not take notes"
    correctIndex: 1
    explanation: "Short symbols keep you focused on listening while capturing essential information."
premium: false
priceCAD: 12
draft: false
---
## Goal
Apply **CELPIP Listening: Note-Taking with a Symbol System** to produce clearer, higher-scoring CELPIP writing.

## What CELPIP Listening: Note-Taking with a Symbol System Changes in Writing
This lesson is about using **CELPIP Listening: Note-Taking with a Symbol System** to improve clarity, development, and control. Examiners reward writing that is direct, logical, and easy to follow.

## Topic Explanation and Use
CELPIP Listening: Note-Taking with a Symbol System is a writing control skill that shapes how ideas are sequenced, supported, and interpreted by the reader.
...
1. Turn the prompt into one specific claim linked to **CELPIP Listening: Note-Taking with a Symbol System**.
...
Write 5-6 sentences using **CELPIP Listening: Note-Taking with a Symbol System**.
