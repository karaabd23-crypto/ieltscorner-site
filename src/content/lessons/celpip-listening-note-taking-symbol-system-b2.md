---
title: "CELPIP Listening: Note-Taking with a Symbol System (B2)"
category: "listening"
level: "B2"
ieltsBand: "6.5-7.5"
clb: "8-9"
exam: ["CELPIP"]
excerpt: "B2 listening lesson on CELPIP Listening: Note-Taking with a Symbol System with task strategy, attention control, and review routines."
date: "2026-03-09"
...
<p>Effective listening notes are short, fast, and selective. In listening tasks, full sentences slow you down and make you miss the next idea. A symbol system lets you record key content such as direction changes, numbers, speaker attitudes, and compare/contrast points while your attention stays on the audio.</p>
<p>Use symbols, arrows, abbreviations, and short nouns rather than complete grammar. The best notes capture information that disappears quickly: dates, prices, opinions, changes, and conditions.</p>
<p>At B2 level, listening gains usually come from better attention control, not from trying to hear every word.</p>
  ...
  <section class="lesson-panel lesson-panel-pattern">
    ...
    <div class="lesson-pattern-stack"><div class="lesson-pattern-sentence">meet 3pm -&gt; 4pm / rm B / prof late</div>
<div class="lesson-pattern-sentence">plan A x / instead bus + taxi / cost $18</div></div>
  </section>
  <section class="lesson-panel lesson-panel-remember">
    <p class="lesson-panel-label">Remember this</p>
    <ul><li>Prepare a small symbol system before practice starts.</li><li>Listen for question focus and key categories such as time, price, opinion, or problem.</li><li>Write only keywords, initials, numbers, and arrows.</li><li>Mark contrast or correction signals such as but, however, actually, and instead.</li><li>Use the notes to confirm the answer, not to guess beyond the audio.</li></ul>
  </section>
</div>
...
<article class="practice-task" data-task-type="order" data-task-answer="Prepare a small symbol system before practice starts.||Listen for question focus and key categories such as time, price, opinion, or problem.||Write only keywords, initials, numbers, and arrows.||Mark contrast or correction signals such as but, however, actually, and instead." data-task-id="1">
...
<button type="button" class="practice-chip" data-chip-value="Prepare a small symbol system before practice starts." data-chip-origin="bank-1" data-chip-id="1-0">
  Prepare a small symbol system before practice starts.
</button>
<button type="button" class="practice-chip" data-chip-value="Write only keywords, initials, numbers, and arrows." data-chip-origin="bank-1" data-chip-id="1-1">
  Write only keywords, initials, numbers, and arrows.
</button>
<button type="button" class="practice-chip" data-chip-value="Mark contrast or correction signals such as but, however, actually, and instead." data-chip-origin="bank-1" data-chip-id="1-2">
  Mark contrast or correction signals such as but, however, actually, and instead.
</button>
<button type="button" class="practice-chip" data-chip-value="Listen for question focus and key categories such as time, price, opinion, or problem." data-chip-origin="bank-1" data-chip-id="1-3">
