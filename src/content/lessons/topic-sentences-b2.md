...
---
## Goal
Master **Topic Sentences and Supporting Details** for B2 (controlled complexity) performance in IELTS/CELPIP contexts.
...
Write one argumentative paragraph (6 sentences) using **Topic Sentences and Supporting Details**.
Requirements:
- claim + counterpoint
...
## Level Deep Dive (B2)
At B2, your writing should show controlled development. Use Topic Sentences and Supporting Details to build argument progression: claim, evidence, implication.
