...
clb: "5-6"
exam: ["IELTS", "CELPIP"]
excerpt: "Learn opinion words and phrases for B1 level. Clear explanations with practical examples and exercises for IELTS and CELPIP."
date: "2026-03-02"
...
This lesson teaches Opinion Words and Phrases for intermediate learners, so you can choose more precise words in IELTS and CELPIP responses.
...
<tbody>
  <tr style="border: 1px solid #ddd;">
    ...
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>The speaker gave a clear example of opinion words and phrases during the lesson.</em></td>
  ...
  <tr style="background: #fafafa; border: 1px solid #ddd;">
    ...
    <td style="padding: 0.75rem; border: 1px solid #ddd;"><em>We practiced useful phrases related to opinion words and phrases in pairs.</em></td>
...
```
The essay used opinion words and phrases in a not clear way.
```

### ✅ Correct

```
The essay used opinion words and phrases in a clearer and more precise way.
```
...
> "In this sentence, opinion words and phrases is used accurately to express the intended meaning."

**Why this works:** It shows correct grammar control and clear communication.

### Example 2: CELPIP Speaking
> "I used opinion words and phrases in my response to make the message precise and natural."
