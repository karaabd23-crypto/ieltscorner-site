...
quiz:
  - prompt: "Which sentence uses Controlling Your Tone Formally correctly?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 matches the main rule for Controlling Your Tone Formally and keeps the sentence natural."
  - prompt: "What should you check first when editing Controlling Your Tone Formally?"
    options:
  ...
  - prompt: "Which edit fixes a common Controlling Your Tone Formally mistake?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Controlling Your Tone Formally error and matches the target form."
premium: false
priceCAD: 0
draft: false
---
...
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This correction matches the intended meaning and keeps Controlling Your Tone Formally natural.</p>
</article>
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This version sounds more natural because Controlling Your Tone Formally fits the sentence clearly.</p>
</article>
</div>
...
<article class="practice-task" data-task-type="choice" data-task-answer="1" data-task-id="0" data-correct-feedback="Correct. The better sentence keeps the intended meaning and the Controlling Your Tone Formally form fits naturally." data-wrong-feedback="Not yet. Check what the sentence really means before you choose the form.">
...
<article class="practice-task" data-task-type="typing" data-task-answers="This suggests the project could benefit many communities." data-task-id="2" data-correct-feedback="Correct. You repaired the sentence without changing the message." data-wrong-feedback="Not yet. Check the target form, then type the full corrected sentence.">
  ...
  <h3>Rewrite the sentence so Controlling Your Tone Formally is correct.</h3>
