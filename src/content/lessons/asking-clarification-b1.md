...
Write one paragraph (5 sentences) about a common social topic using **Asking for Clarification**.
Requirements:
- one clear claim
- one support reason
...
## Level Deep Dive (B1)
At B1, you should manage paragraph unity. Use Asking for Clarification to support one central point with simple but clear logic.
