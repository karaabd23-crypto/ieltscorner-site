...
clb: "11-12"
exam: ["IELTS", "CELPIP"]
excerpt: "C2 vocabulary lesson on Advanced Formal Expression with unpacked explanations, aligned practice, and model answers."
date: "2026-02-27"
...
---
## Goal
Use **Advanced Formal Expression** vocabulary precisely with maximum precision under time pressure.

## Concept Unpacked
Strong vocabulary performance is not about rare words; it is about choosing words and collocations that are semantically exact for the context. At C2, use expert-level synthesis and refinement.
...
- Does vocabulary meet C2 target: demonstrate evaluator-friendly mastery?
