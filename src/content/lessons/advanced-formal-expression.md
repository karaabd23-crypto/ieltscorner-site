...
quiz:
  - prompt: "What is the safest way to learn vocabulary for Advanced Formal Expression?"
    options:
...
## Examples
<p class="lesson-section-lede">&#10024; <strong>Read the examples first.</strong> They show the pattern for <u>Advanced Formal Expression</u> in real sentences.</p>
