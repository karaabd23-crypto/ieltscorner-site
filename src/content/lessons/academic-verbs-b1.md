...
<div class="lesson-resource-grid">
  <article class="lesson-resource-card">
    ...
    <ul><li>analyze: examine information carefully</li><li>indicate: show a result or trend</li><li>demonstrate: show clearly with evidence</li><li>justify: give reasons or evidence for a claim</li><li>evaluate: judge strengths and weaknesses</li><li>interpret: explain the meaning of information</li></ul>
  </article>
  <article class="lesson-resource-card">
    <p class="lesson-card-label">Useful chunks</p>
    <ul><li>analyze data</li><li>highlight a trend</li><li>demonstrate a result</li><li>justify a claim</li></ul>
  </article>
  <article class="lesson-resource-card">
    <p class="lesson-card-label">Sentence frames</p>
    <ul><li>The data indicate that...</li><li>This pattern suggests that...</li><li>One explanation is that...</li></ul>
  </article>
</div>
