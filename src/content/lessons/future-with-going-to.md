...
clb: "4-5"
exam: ["IELTS", "CELPIP"]
excerpt: "A2 grammar lesson on Future with going to with unpacked explanations, aligned practice, and model answers."
date: "2026-02-27"
...
---
## Goal
Master **Future with going to** with simple linked sentences.
...
Write 4 sentences using **Future with going to**:
- one statement
...
Use **Future with going to** at least twice and keep your logic clear.
