...
quiz:
  - prompt: "Which sentence uses Building Longer Noun Groups correctly?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 matches the main rule for Building Longer Noun Groups and keeps the sentence natural."
  - prompt: "What should you check first when editing Building Longer Noun Groups?"
    options:
  ...
  - prompt: "Which edit fixes a common Building Longer Noun Groups mistake?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Building Longer Noun Groups error and matches the target form."
premium: false
priceCAD: 0
draft: false
---
...
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This correction matches the intended meaning and keeps Building Longer Noun Groups natural.</p>
</article>
<article class="lesson-example-card">
  ...
  <p class="lesson-card-note">This version sounds more natural because Building Longer Noun Groups fits the sentence clearly.</p>
</article>
</div>
