...
quiz:
  - prompt: "Which version uses Reporting What Others Said accurately?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 matches the main rule for Reporting What Others Said and keeps the sentence natural."
  - prompt: "What is the first thing to settle when you work on Reporting What Others Said?"
    options:
  ...
  - prompt: "Which edit repairs a typical Reporting What Others Said error?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Reporting What Others Said error and matches the target form."
premium: true
priceCAD: 12
draft: false
---
<div class="lesson-context"><p class="lesson-context-lead"><strong>Reporting What Others Said</strong> helps you accurately convey what someone else has communicated. This involves adjusting tenses, pronouns, and time expressions to fit the context of the report. Mastering this skill enhances clarity in both verbal and written communication.</p></div>
