...
clb: "2-3"
exam: ["IELTS", "CELPIP"]
excerpt: "A1 lesson on Some and Any with teacher-style explanation, guided practice, and topic-linked review."
date: "2026-03-02"
...
quiz:
  - prompt: "Which sentence uses Some and Any correctly?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 matches the main rule for Some and Any and keeps the sentence natural."
  - prompt: "What should you check first when editing Some and Any?"
    options:
  ...
  - prompt: "Which edit fixes a common Some and Any mistake?"
    options:
    ...
    correctIndex: 1
    explanation: "Option 2 repairs a typical Some and Any error and matches the target form."
---
<div class="lesson-context"><p class="lesson-context-lead"><strong>Some and Any</strong> helps you talk about number and amount clearly. English changes the form depending on whether the noun is countable, uncountable, small in number, or large in amount. In this lesson, you will learn how to choose the right quantity word for the noun.</p></div>

## Examples
<p class="lesson-section-lede">&#10024; <strong>Read the examples first.</strong> They show the pattern for <u>Some and Any</u> in real sentences.</p>
...
<article class="practice-task" data-task-type="choice" data-task-answer="1" data-task-id="0" data-correct-feedback="Correct. The better sentence keeps the intended meaning and the Some and Any form fits naturally." data-wrong-feedback="Not yet. Check what the sentence really means before you choose the form.">
...
<article class="practice-task" data-task-type="typing" data-task-answers="The clinic report shows progress, but one sentence switches tense without reason." data-task-id="2" data-correct-feedback="Correct. You repaired the sentence without changing the message." data-wrong-feedback="Not yet. Check the target form, then type the full corrected sentence.">
  ...
  <h3>Rewrite the sentence so Some and Any is correct.</h3>
...
## Why It Matters
<p class="lesson-importance"><strong>&#127919; Why it matters:</strong> small words before nouns often decide whether the message sounds natural or strange. When you control <u>Some and Any</u>, your sentences become more accurate and much easier for the reader or listener to trust.</p>
