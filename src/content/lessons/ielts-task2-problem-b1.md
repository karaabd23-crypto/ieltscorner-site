...
---
<div class="lesson-context"><p class="lesson-context-lead"><strong>IELTS Writing Task 2: Problem-Solution</strong> asks you to explain a problem clearly and give solutions that really match it. Strong answers define the problem well, then suggest practical solutions with clear results. In this lesson, you will learn how to keep the problem and solution connected from start to finish.</p></div>

## Examples
<p class="lesson-section-lede">&#10024; <strong>Read the examples first.</strong> They show the pattern for <u>IELTS Writing Task 2: Problem-Solution</u> in real sentences.</p>
...
<article class="practice-task" data-task-type="choice" data-task-answer="1" data-task-id="0">
  ...
  <h3>Choose the stronger move for IELTS Writing Task 2: Problem-Solution.</h3>
...
## Why It Matters
<p class="lesson-importance"><strong>&#127919; Why it matters:</strong> problem-solution tasks lose marks fast when the solution does not really answer the problem. When you keep the link clear, your essay feels more logical, more complete, and much easier to score well.</p>
