...
---
## Goal
Master **Word Order for Emphasis** with maximum precision under time pressure.
...
Write 4 sentences using **Word Order for Emphasis**:
- one statement
...
Use **Word Order for Emphasis** at least twice and keep your logic clear.
