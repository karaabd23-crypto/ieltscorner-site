...
quiz:
  - prompt: "Pick the sentence that gets Some and Any right."
    options:
  ...
  - prompt: "When you review Some and Any, what should you look at before anything else?"
    options:
  ...
  - prompt: "Which change fixes a frequent Some and Any mistake?"
    options:
...
---
<div class="lesson-context"><p class="lesson-context-lead"><strong>Some and Any</strong> are essential quantifiers in English that help specify an indefinite amount or number of items. Understanding their correct usage is crucial for forming grammatically accurate sentences, especially when asking questions, making offers, or stating negatives.</p></div>
