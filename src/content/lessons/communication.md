...
quiz:
  - prompt: "What is the safest way to learn vocabulary for Communication?"
    options:
...
<div class="lesson-resource-grid">
  <article class="lesson-resource-card">
    ...
    <ul><li>clarify: make a point easier to understand</li><li>misunderstanding: failure to understand correctly</li><li>feedback: comments used for improvement</li><li>tone of voice: the manner of speaking</li><li>body language: non-verbal communication</li><li>active listening: listening carefully and responding thoughtfully</li></ul>
  </article>
  <article class="lesson-resource-card">
