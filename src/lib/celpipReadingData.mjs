...
export const CELPIP_READING_FREE_TEST = {
  ...
  sections: [
       ...
       ────────────────────────────────────────────────────────── */
    {
      ...
      passage: [
        'From: Priya Mehta, Health and Safety Coordinator',
        'To: All Building 3 staff',
        'Subject: Updated safety training requirements for Q3',
        '',
        'Hello everyone,',
        '',
        'As part of our annual compliance review, the company has updated the mandatory safety training schedule for all staff in Building 3. Please read the following changes carefully, as some deadlines have been moved forward.',
        '',
        'All employees must complete the online fire safety module by July 15. Previously, the deadline was August 1, but the provincial auditor will visit in the last week of July, so all records must be finalized earlier. The module takes approximately 45 minutes and can be accessed through the staff portal under "Training."',
        '',
        'Employees who work with chemicals must also attend the in-person WHMIS refresher on either July 8 or July 12. Both sessions run from 9:00 a.m. to 12:00 p.m. in Conference Room 2B. Space is limited to 25 per session, so please register through the portal by June 28. Anyone who does not register by that date will be automatically assigned to the July 12 session if seats remain.',
        '',
        'Supervisors should note that team members who completed WHMIS training within the past six months do not need to attend again, but they must still complete the fire safety module. If you believe someone on your team qualifies for the exemption, email me directly with the employee\'s name, training date, and certificate number.',
        '',
        'Thank you for making this a priority.',
        '',
        'Priya Mehta',
        'Health and Safety Coordinator, Building 3',
        '',
        '---',
        '',
        'From: Daniel Okafor, Lab Technician',
        'To: Priya Mehta',
        'Subject: RE: Updated safety training requirements for Q3',
        '',
        'Hi Priya,',
        '',
        'Thank you for the update. I have a few questions about the {{BLANK:q1}} for our department.',
        '',
        'I completed WHMIS training in April, so I believe I qualify for the {{BLANK:q2}}. I will send you my certificate details separately. However, I still need to complete the fire safety {{BLANK:q3}} before the new deadline.',
        '',
        'One of my colleagues, Tariq, started working here in May and has not taken any safety training yet. Could you confirm whether he needs to attend {{BLANK:q4}} the WHMIS refresher and the fire safety module?',
        '',
        'Also, Tariq works the afternoon shift and cannot attend the morning sessions. Is there an {{BLANK:q5}} for employees who have scheduling conflicts? If not, I would like to suggest that an afternoon session be added.',
        '',
       ...
       ────────────────────────────────────────────────────────── */
    {
      ...
      passage: [
        'The City of Maplewood recently updated its curbside waste sorting rules. All households must separate waste into four streams: blue box (recyclables), green bin (organics), grey bin (garbage), and special drop-off items. Collection happens weekly on each resident\'s designated day.',
        '',
        'Blue box materials include clean paper, cardboard, metal cans, glass bottles, and rigid plastics marked with recycling symbols 1 through 5. Plastic bags, styrofoam, and soft plastics such as chip bags cannot go in the blue box. Instead, soft plastics should be collected in a single transparent bag and placed on top of the blue box on collection day.',
        '',
        'The green bin accepts all food scraps, including meat and dairy, as well as soiled paper products such as paper towels and pizza boxes. Yard waste like leaves and small branches may go in the green bin only between April and November. From December through March, yard waste must be bundled separately and placed beside the green bin.',
        '',
        'The grey bin is for items that do not fit into the other three streams. Common examples include broken ceramics, diapers, and heavily soiled items that cannot be composted. Household hazardous waste such as paint, batteries, and motor oil must never go in any curbside bin. These items require a special drop-off at the Maplewood Environmental Centre, which is open Saturdays from 8:00 a.m. to 3:00 p.m.',
      ],
      diagram: {
        caption: 'Maplewood Curbside Waste Sorting Guide',
        headers: ['Waste Stream', 'Bin', 'Accepted', 'Not Accepted'],
        rows: [
          ['Recyclables', 'Blue box', 'Clean paper, cardboard, metal cans, glass bottles, rigid plastics #1–5', 'Plastic bags, styrofoam, soft plastics'],
          ['Organics', 'Green bin', 'Food scraps (all types), soiled paper, yard waste (Apr–Nov)', 'Yard waste Dec–Mar (bundle separately)'],
          ['Garbage', 'Grey bin', 'Broken ceramics, diapers, non-compostable soiled items', 'Hazardous waste'],
          ['Special drop-off', 'Environmental Centre', 'Paint, batteries, motor oil, hazardous waste', 'Saturdays 8 a.m.–3 p.m. only'],
        ],
      },
      questions: [
        {
