const LESSON_LIBRARY = {
  task1Email: {
    ...
    href: '/lessons/writing/celpip-task1-email-b2/',
  ...
  task2Survey: {
    key: 'task2-survey',
    title: 'CELPIP Task 2: Survey Response (B2)',
    href: '/lessons/writing/celpip-task2-survey-b2/',
  ...
  task2Opinion: {
    key: 'task2-opinion',
    title: 'CELPIP Writing Task 2: Opinion (B2)',
    href: '/lessons/writing/celpip-task2-opinion-b2/',
    reason: 'Use this when your position is unclear or weak.',
  },
  paragraphCoherence: {
    key: 'paragraph-coherence',
    title: 'Paragraph Coherence (B2)',
    href: '/lessons/writing/paragraph-coherence-b2/',
    reason: 'Use this when ideas do not connect clearly from sentence to sentence.',
  },
  bodyParagraphs: {
    key: 'essay-body-paragraphs',
    title: 'Essay Body Paragraphs (B2)',
    href: '/lessons/writing/essay-body-paragraphs-b2/',
    reason: 'Use this when body paragraphs need one clear job and better support.',
  },
  linkingWords: {
    key: 'linking-words',
    title: 'Linking Words (B2)',
    href: '/lessons/writing/linking-words-b2/',
  ...
  punctuation: {
    key: 'punctuation',
    title: 'Punctuation for Academic Writing (B2)',
    href: '/lessons/writing/punctuation-academic-b2/',
    reason: 'Use this when punctuation makes the writing hard to follow.',
  },
  formalVsInformal: {
    key: 'formal-vs-informal',
    title: 'Formal vs Informal Language (B2)',
    href: '/lessons/writing/formal-vs-informal-b2/',
  ...
  articles: {
    key: 'articles',
    title: 'Articles: A, An, The (B2)',
    href: '/lessons/grammar/articles-a-an-the-b2/',
    reason: 'Use this when article errors affect clarity.',
  },
  tenses: {
    key: 'tenses',
    title: 'Twelve Tenses (B2)',
    href: '/lessons/grammar/twelve-tenses-b2/',
    reason: 'Use this when tense control shifts without a reason.',
  },
  agreement: {
    key: 'agreement',
    title: 'Subject-Verb Agreement (B2)',
    href: '/lessons/grammar/subject-verb-agreement-b2/',
    reason: 'Use this when grammar control drops in core sentence patterns.',
  },
  wordForm: {
    key: 'word-form',
    title: 'Word Formation: Suffixes (B2)',
    href: '/lessons/grammar/word-formation-suffixes-b2/',
